...
namespace App\Http\Controllersbackup\Admin;



use App\Http\Controllersbackup\Controller;
...

{
...

    {
        ...
        if ($request->filled('car_type') || $request->filled('start_date') || $request->filled('payment_method')) {
            ...
            $cancel_rides = Ride::where(['is_past' =>  0,'status' => 3])->whereNull('cancel_remarks')->count();

            $user_canceled = Ride::where(['is_past' =>  0,'status' => 3])->whereNotNull('cancel_remarks')->count();
...
//
    ...
    return $pdf->download('invoice_' . Carbon::now()->timestamp . '.pdf');
...

    {
        ...
        if ($request->filled('car_type') || $request->filled('start_date') || $request->filled('payment_method')) {
            ...
            $cancel_rides = Ride::where('is_past', 1)->where('status', 3)->whereNull('cancel_remarks')->where($applyFilters)->count();

            $user_canceled = Ride::where(['is_past' => 1,'status' => 3])->whereNotNull('cancel_remarks')->where($applyFilters)->count();
            ...
            $cancel_rides = Ride::where(['is_past' =>  1,'status' => 3])->whereNull('cancel_remarks')->count();

            $user_canceled = Ride::where(['is_past' => 1,'status' => 3])->whereNotNull('cancel_remarks')->count();
...

    {
        ...
        if ($status_id == 3) {
            ...
            if ($request->cancel_type == "admin-cancel") {
                ...
                $rides = Ride::where(['status' =>  $status_id,'is_past'=> 0])->whereNull('cancel_remarks')->orderBy('id', 'DESC')->paginate(10);

            }else{



                $rides = Ride::where(['status' =>  $status_id,'is_past'=> 0])->whereNotNull('cancel_remarks')->orderBy('id', 'DESC')->paginate(10);
...

    {
        ...
        if ($status_id == 3) {
            ...
            if ($request->cancel_type == "admin-cancel") {
                ...
                $rides = Ride::where(['status' => $status_id,'is_past' =>  1])->whereNull('cancel_remarks')->orderBy('id', 'DESC')->paginate(10);

            }else{

              $rides = Ride::where(['status' => $status_id,'is_past' =>  1])->whereNotNull('cancel_remarks')->orderBy('id', 'DESC')->paginate(10);  
