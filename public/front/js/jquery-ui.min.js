...
((t) => {
  ...
  (X.cleanData =
    ...
    (X.widget.extend = function (t) {
      for (var e, i, s = d.call(arguments, 1), n = 0, o = s.length; n < o; n++)
        for (e in s[n])
          (i = s[n][e]),
            u.call(s[n], e) &&
              void 0 !== i &&
  ...
  (k = Math.max),
    ...
    (X.fn.position = function (u) {
      ...
      return u && u.of
        ? ((_ =
            "string" == typeof (u = X.extend({}, u)).of
              ? X(document).find(u.of)
              : X(u.of)),
          ...
          this.each(function () {
            var i,
              ...
              e = C(this, "marginLeft"),
              s = C(this, "marginTop"),
              n = r + e + C(this, "marginRight") + b.width,
  ...
  X.ui.position,
      ...
      return "area" === o
        ? ((n = (i = t.parentNode).name),
          !(!t.href || !n || "map" !== i.nodeName.toLowerCase()) &&
            0 < (i = X("img[usemap='#" + n + "']")).length &&
            i.is(":visible"))
        : (/^(input|select|textarea|button|object)$/.test(o)
            ? (s = !t.disabled) &&
              (n = X(t).closest("fieldset")[0]) &&
              (s = !n.disabled)
            : (s = ("a" === o && t.href) || e),
          s && X(t).is(":visible") && "visible" === X(t).css("visibility"));
    }),
    X.extend(X.expr.pseudos, {
    ...
    (X.ui.formResetMixin = {
      ...
      _bindFormResetHandler: function () {
        var t;
        (this.form = X(this.element.prop("form"))),
          this.form.length &&
    ...
    m =
      ...
      X.widget("ui.draggable", X.ui.mouse, {
        ...
        _blurActiveElement: function (t) {
          ...
          X(t.target).closest(e).length || X(e).trigger("blur");
        },
      ...
      X.widget("ui.resizable", X.ui.mouse, {
        ...
        _getElementTheoreticalSize: function (t, e, i) {
          return (
            Math.max(
              0,
              Math.ceil(
                t.get(0)["offset" + i[0].toUpperCase() + i.slice(1)] -
                  e[i] -
                  0.5
              )
            ) || 0
        ...
        _renderProxy: function () {
          ...
          (this.elementOffset = t.offset()),
            this._helper
              ? ((this.helper =
                  this.helper || X("<div></div>").css({ overflow: "hidden" })),
        ...
        stop: function (e) {
          ...
          i.element.animate(X.extend(n, a && o ? { top: a, left: o } : {}), {
            ...
            step: function () {
              ...
              s &&
                s.length &&
                X(s[0]).css({ width: t.width, height: t.height }),
                i._updateCache(t),
        ...
        _getRadioGroup: function () {
          ...
          return t
            ? (this.form.length
                ...
                : X(e).filter(function () {
                    return 0 === X(X(this).prop("form")).length;
                  })
              ).not(this.element)
            : X([]);
        },
  ...
  function b() {
    X.datepicker._isDisabledDatepicker(
      (f.inline ? f.dpDiv.parent() : f.input)[0]
    ) ||
      (X(this)
  ...
  X.extend(X.ui, { datepicker: { version: "1.14.1" } }),
    X.extend(_.prototype, {
      ...
      _attachments: function (t, e) {
        ...
        e.append && e.append.remove(),
          s &&
            ((e.append = X("<span>").addClass(this._appendClass).text(s)),
          ...
          ("button" !== s && "both" !== s) ||
            ...
            this._get(e, "buttonImageOnly")
              ...
              : ((e.trigger = X("<button type='button'>").addClass(
                  this._triggerClass
                )),
                i
                  ? e.trigger.html(
                      X("<img>").attr({ src: i, alt: s, title: s })
                    )
                  : e.trigger.text(s)),
        ...
        "input" !== (t = t.target || t).nodeName.toLowerCase() &&
          ...
          X.datepicker._isDisabledDatepicker(t) ||
            ...
            X.datepicker._curInst &&
              ...
              (X.datepicker._curInst.dpDiv.stop(!0, !0), n) &&
              X.datepicker._datepickerShowing &&
      ...
      _updateDatepicker: function (t) {
        (this.maxRows = 4),
          (f = t).dpDiv.empty().append(this._generateHTML(t)),
      ...
      _findPos: function (t) {
        for (
          ...
          t &&
          ("hidden" === t.type || 1 !== t.nodeType || X.expr.pseudos.hidden(t));
        ...
        if ((E < 0 && ((E += 12), A--), N))
          for (
            e = this._daylightSavingAdjust(
              new Date(
                N.getFullYear(),
                N.getMonth() - z[0] * z[1] + 1,
                N.getDate()
              )
            ),
              e = H && e < H ? H : e;
            this._daylightSavingAdjust(new Date(A, E, 1)) > e;
        ...
        for (
          t.drawMonth = E,
            ...
            S = T
              ? this.formatDate(
                  S,
                  this._daylightSavingAdjust(new Date(A, E - I, 1)),
                  this._getFormatConfig(t)
                )
              : S,
            i = this._canAdjustMonth(t, -1, A, E)
              ? X("<a>")
                  .attr({
            ...
            S = T
              ...
              : S,
            s = this._canAdjustMonth(t, 1, A, E)
              ? X("<a>")
                  .attr({
            ...
            I = this._get(t, "currentText"),
            M = this._get(t, "gotoCurrent") && t.currentDay ? P : U,
            I = T ? this.formatDate(I, M, this._getFormatConfig(t)) : I,
            S = "",
            t.inline ||
              (S = X("<button>")
                .attr({
            ...
            T = "",
            x &&
              (T = X("<div class='ui-datepicker-buttonpane ui-widget-content'>")
                .append(C ? S : "")
                .append(
                  this._isInRange(t, M)
                    ? X("<button>")
          ...
          for (d = "", this.maxRows = 4, p = 0; p < z[1]; p++) {
            if (
              ((f = this._daylightSavingAdjust(new Date(A, E, t.selectedDay))),
              (g = " ui-corner-all"),
              (m = ""),
              q)
            ) {
              if (((m += "<div class='ui-datepicker-group"), 1 < z[1]))
                switch (p) {
                  case 0:
                    (m += " ui-datepicker-group-first"),
                      (g = " ui-corner-" + (C ? "right" : "left"));
                    break;
                  case z[1] - 1:
                    (m += " ui-datepicker-group-last"),
                      (g = " ui-corner-" + (C ? "left" : "right"));
                    break;
                  default:
            ...
            for (
              m +=
                ...
                g +
                "'>" +
                (/all|left/.test(g) && 0 === u ? (C ? s : i) : "") +
                (/all|right/.test(g) && 0 === u ? (C ? i : s) : "") +
            ...
            for (
              m += _ + "</tr></thead><tbody>",
                b = this._getDaysInMonth(A, E),
                A === t.selectedYear &&
                  E === t.selectedMonth &&
                  (t.selectedDay = Math.min(t.selectedDay, b)),
                v = (this._getFirstDayOfMonth(A, E) - n + 7) % 7,
                b = Math.ceil((v + b) / 7),
                j = q && this.maxRows > b ? this.maxRows : b,
                this.maxRows = j,
                y = this._daylightSavingAdjust(new Date(A, E, 1 - v)),
                B = 0;
              B < j;
              B++
            ) {
                  ...
                  (K +=
                    ...
                    (k && !r
                      ...
                      : "<a class='ui-state-default" +
                        ...
                        "' href='#' aria-current='" +
                        (y.getTime() === P.getTime() ? "true" : "false") +
                        "' data-date='" +
                        y.getDate() +
                        "'>" +
                        y.getDate() +
    ...
    close: function (t) {
      ...
      this._isOpen &&
        ...
        this.opener.filter(":focusable").trigger("focus").length ||
          X(this.document[0].activeElement).trigger("blur"),
        ...
        (this.activeMenu = this.element),
          ...
          this._on({
            ...
            "click .ui-menu-item": function (t) {
              var e = X(t.target),
                i = X(this.document[0].activeElement);
              !this.mouseHandled &&
    ...
    X.widget("ui.tooltip", {
      ...
      _open: function (t, e, i) {
        var s,
          n,
          o,
          a = X.extend({}, this.options.position);
        function r(t) {
        ...
        i &&
          ((o = this._find(e))
            ...
            : (e.is("[title]") &&
              ...
              (o = X("<div>").html(s.find(".ui-tooltip-content").html()))
                .removeAttr("name")
                .find("[name]")
                .removeAttr("name"),
              ...
              this.options.track && t && /^mouse/.test(t.type)
                ...
                : s.position(X.extend({ of: e }, this.options.position)),
              s.hide(),
              this._show(s, this.options.show),
              this.options.track &&
                this.options.show &&
                this.options.show.delay &&
                (n = this.delayedShow = setInterval(function () {
