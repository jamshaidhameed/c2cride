                ...
                <tr>
                    ...
                    <td width="540">
                        <table cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td style="font-size: 13px; line-height: 140%; font-weight: 400; color: #ffffff;">You've received this email because you have an account with C2C Ride. <a href="{{url('user/setting')}}" style="text-decoration: none; color: #00B77B;">View your C2C Ride Profile settings.</a></td>
                            </tr>
                            <tr>
                                <td height="30"></td>
                            </tr>
