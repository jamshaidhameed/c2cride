    ...
    <tr>
        ...
        <td width="540">
            <table width="100%" cellpadding="0" cellspacing="0" >
                <tr><td><img src="{{asset('images/booking_request_update_icon.png')}}" alt="" style="max-width: 100%; display: block; margin: auto;"></td></tr>
                <tr><td height="20"></td></tr>
                <tr><td style="font-size: 15px; line-height: 140%; font-weight: 600; color: #000; text-align: center;">Booking Updated</td></tr>
                ...
                <tr><td style="font-size: 13px; line-height: 140%; font-weight: 400; color: #000;">Your booking has been updated as requested. Please review the changes at your convenience.</td></tr>
                <tr><td height="20"></td></tr>
...
{{--                                @endif--}}
                ...
                <tr><td height="30"></td></tr>
                <tr><td style="font-size: 13px; line-height: 140%; font-weight: 400; color: #000;">For any queries or further adjustments, feel free to contact us.</td></tr>
