    ...
    <tr>
        ...
        <td width="540">
            <table width="100%" cellpadding="0" cellspacing="0" >
                <tr><td><img src="{{asset('images/reschedule_request_icon.png')}}" alt="" style="max-width: 100%; display: block; margin: auto;"></td></tr>
                <tr><td height="20"></td></tr>
                <tr><td style="font-size: 15px; line-height: 140%; font-weight: 600; color: #000; text-align: center;">Reschedule Request</td></tr>
                ...
                <tr><td style="font-size: 13px; line-height: 140%; font-weight: 400; color: #000;">Your Booking Reschedule request has been received, Please allow our team some time to confirm your ride.</td></tr>
                <tr><td height="20"></td></tr>
                    ...
                    <td>
                        <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #EDEDED; padding: 15px;">
                            ...
                            <tr>
                                ...
                                <td style="font-size: 13px; line-height: 140%; font-weight: 400; text-align: right; color: #575757;">{{ $ride->distance }} Kilometer / {{ str_replace('mins','min',str_replace('hour','hr',$ride->duration)) }}</td>
                            </tr>
