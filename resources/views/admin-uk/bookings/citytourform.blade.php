...
<div class="gerenric-form">
    <ul>
        <li>
            <div class="row">
                <div class="col-lg-4 mb-3"><label class="form-label">Pick-up Location</label>
                    <input name="source" type="text" class="form-control source3" placeholder="Street - Barsha Heights - Dubai - Elvish" value="{{$ride->source}}"></div>
                <div class="col-lg-4 mb-3"><label class="form-label">Drop-off Location</label>
                    <input type="text" name="destination" class="form-control destination3" placeholder="Street - Barsha Heights - Dubai - Elvish" value="{{$ride->destination}}"></div>
        ...
        <li>
            <div class="row">
                <div class="col-lg-12"><label class="form-label">Ride Distance & Time</label></div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="form-icon-row">
                        ...
                        <input type="text" name="duration" class="form-control pd-left-60" placeholder="04 hrs 30 mins" value="{{$ride->duration}}">
                    </div>
                </div>
            </div>
        </li>
            ...
            <div class="row">
                <div class="col-lg-3  mb-3">
                    <div class="passenger-add-tp">
                        ...
                        <div class="passenger-add-tp-inner">
                            <input type="text" class="plusminus-input" name="adults"  id="city_qty_1_CR" maxlength="6">
                            <div class="plusminus-button">
                                <span class="minus-btn city_min_1_CR">-</span><span class="plus-btn city_plus_1_CR">+</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 mb-3">
                    <div class="passenger-add-tp">
                        ...
                        <div class="passenger-add-tp-inner">
                            <input type="text" class="plusminus-input" name="children" id="city_qty_2_CR" maxlength="6">
                            <div class="plusminus-button">
                                <span class="minus-btn city_min_2_CR">-</span><span class="plus-btn city_plus_2_CR">+</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 mb-3">
                    <div class="passenger-add-tp">
                        ...
                        <div class="passenger-add-tp-inner">
                            <input type="text" class="plusminus-input" name="luggage" id="city_qty_3_CR" maxlength="6">
                            <div class="plusminus-button">
                                <span class="minus-btn city_min_3_CR">-</span><span class="plus-btn city_plus_3_CR">+</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="passenger-add-tp">
                        ...
                        <div class="passenger-add-tp-inner">
                            <input type="text" class="plusminus-input" name="child_seats" id="city_qty_4_CR" max="1">
                            <div class="plusminus-button">
                                <span class="minus-btn city_min_4_CR">-</span><span class="plus-btn city_plus_4_CR">+</span>
                            </div>
                        </div>
                    </div>
                </div>
...
{{--                        <input type="text" name="car" class="form-control pd-left-60" placeholder="Economy" value="{{$ride->car}}">--}}
                        ...
                        <select id="carselect" name="car" class="form-control" >
            ...
            <div class="row">
                @if($ride->flight_number)
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-icon-row">
                            <div class="form-icon2">
                                <img src="{{asset('images/flight_icon_tp.svg')}}" alt="">
                            </div>
            ...
            <div class="row">
                <div class="col-lg-7 mb-3">
                    ...
                    <div class="form-icon-row">
                        ...
                        <input type="text" class="form-control pd-left-60"  name="meet_greet" value="{{$ride->meet_greet}}">
        ...
        <li class="two-button">
            ...
            <button type="submit"  class="btn btn-primary  edit_record">Save</button>
        </li>
    </ul>
</div>
