        ...
        <div class="table-ride-detail">
            ...
            <div class="rd-block">
                ...
                @if($ride->photography_amount > 0)
                     <br>
                    <div class="rd-kg-col">
                        ({{ $ride->photograph}}) <span style="margin-left: 5px; margin-right:5px;"><img src="{{asset('images/city_rides_icon2_t.svg')}}" alt=""></span> ({{ number_format($ride->photography_amount) }})
                    </div>
        ...
        <div class="table-ride-status">
            <div class="ride-status-col">
                ...
                <div class="rd-status-block table-select-box">
                    ...
                    <select name="ride_driver" id="" data-ride_id="{{$ride->id}}" data-status="5" @if($ride->status == '8') disabled @endif>
                ...
                @if($ride->status == 1)
                <br>
                    <a href="javascript:void(0)">Assigned amount : {{ number_format($ride->assigned_amount) }} AED</a>
                @endif
                <br>
