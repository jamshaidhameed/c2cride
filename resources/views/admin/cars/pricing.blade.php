            ...
            <table class="table table-bordered table-sm">
                <thead>
                    <tr>
                        ...
                        <th class="text-center">Airport Extra</th>
                        <th class="text-center"></th>
                    </tr>
                </thead>
                <tbody>
                    @foreach ($hourly_bookings as $hourly)
                        <tr>
                            ...
                            <td class="text-center">{{ $hourly->airport_extra}}</td>
                            <td class="text-center">
            ...
            <div class="reschedule-popup">
                ...
                <div class="modal-body">
                   ...
                   <form action="" method="post" id="hourly-pricing-form">
                    ...
                    <div class="form-group">
                        <label for="" class="form-control-label">Airport Extra</label>
                        <input type="number" name="airport_extra" id="" class="form-control" min="0" step="any" value="">
                    </div>
                    <div class="form-group mt-2 mb-2">
                        <button type="submit" class="btn btn-primary">Save</button>
                    </div>
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                if (data) {
                    ...
                    $(form).find('[name="airport_extra"]').val(data.airport_extra);
