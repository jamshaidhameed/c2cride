        ...
        <div class="page-container">
            ...
            <div class="filter-area">
                ...
                <form action="{{ route('admin.earning') }}" method="GET">
                    ...
                    <div>
                        <label for="" class="form-control-label">Filter by Payment Type</label>
                        <select name="payment_type" id="" class="form-control">
                            <option value="">Choose Filter</option>
                            <option value="cash" @if (!empty($payment_filter) && $payment_filter == "cash")
                                selected
                            @endif>Cash</option>
                            <option value="card" @if (!empty($payment_filter) && $payment_filter == "card")
                                selected
                            @endif>Card</option>
                        </select>
                    </div>
