...
@section('content')
    ...
    <section id="content-section">
        <div class="page-container">
            ...
            <br> <br> 
            <h3><strong>Vendors List</strong></h3>
            <div class="d-flex justify-content-end mb-2">
                <a href="javascript(0)" data-store_url="{{ route('admin.vendor.store') }}" data-save_url = "" class="btn btn-success btn-add float-right"><i class="icon wb-plus-circle"></i>Add Vendor</a>
            </div>
                ...
                <tbody>
                    @foreach($vendors as $vendor)
                     <tr>
                        ...
                        <td class="text-left">{{ $vendor->contact }}</td>
                        ...
                        <td>
                            <a href="" data-update_url ="{{ route('admin.vendor.update',$vendor->id) }}" data-id="{{ $vendor->id}}" data-get_url="{{ route('admin.vendor.show',$vendor->id) }}" type="button" class="btn btn-primary vendor-edit">Edit</a>
                                <a href="{{ route('admin.vendor.destroy',$vendor->id) }}" type="button" class="btn btn-danger" id="delete-record">Delete</a>
                        </td>
                     </tr>
                    @endforeach
                </tbody>
...
@section('js')
  <script>
    $(document).on('click','.btn-add',function(e){
        ...
        $('#driver').find('.modal-title').text('Add New Vendor');
        ...
        $.ajax(
            {
                ...
                success:function(data){
                    ...
                    if (data) {
                        ...
                        $('#driver').find('.modal-title').text('Update Vendor Informations');
