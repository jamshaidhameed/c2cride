                                                        ...
                                                        <div class="v_card_inner">
                                                            ...
                                                            @php $car_type = \App\Models\CarType::where('slug',$vehicle->slug)->first();
                                                                 ...
                                                                 if(session("step_one_data")["ride_type_id"] == 1){
                                                                    ...
                                                                    $is_airport = isThisAirportRide(session("step_one_data")["source"],session("step_one_data")["destination"]);

                                                                    $pricing = !empty($car_type) ? hourly_pricing($car_type,$vehicle->id,$data['byHours_durantion'],$is_airport) : array();
