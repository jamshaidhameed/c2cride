...
@section('meta')
 <meta name="description" content="Choose from hourly or full-day chauffeur rides across Dubai and UAE. Fast online booking with C2C Ride.
" />
@endsection
@section("title")
 Book a Ride | Dubai & Intercity Chauffeur Services with C2C Rides
                    ...
                    <div class="banner_inner">
                        <div class="banner_box">
                            <div class="banner_text">
                                <small class="uppercase animated fadeInUpShort slow">Ride</small>
                                <h1 class="animated fadeInUpShort slow delay-250">
                                    Enjoy <span>next-level</span> rides in the UAE with<span> C2C </span>

                                </h1>
                                <p class="animated fadeInUpShort slow delay-500">Affordable. Hassle-Free. Luxurious. Say goodbye to transportation struggles.</p>
                            </div>
                        </div>
                                    ...
                                    <li class="animated fadeInUpShort slow">
                                        <div class="hw_box">
                                            ...
                                            <div class="hw_box_data">
                                                ...
                                                <p>Input your pickup & drop-off locations or select the number of hours to book & Customize every ride. </p>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="animated fadeInUpShort slow delay-250">
                                        <div class="hw_box">
                                            ...
                                            <div class="hw_box_data">
                                                ...
                                                <p>Select the perfect car to suit your needs. From elegant sedans to spacious SUVs, we've got it all.</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="animated fadeInUpShort slow delay-500">
                                        <div class="hw_box">
                                            ...
                                            <div class="hw_box_data">
                                                ...
                                                <p>Relax in luxury and let us handle the roads. Sit back, and we'll ensure a smooth, memorable ride.</p>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                    ...
                    <div class="banner_inner">
                        <div class="banner_box">
                            <div class="discountBox discountBoxWhite animated slow growIn delay-1000">
                                ...
                                <span>Your First Ride</span>
                            </div>
                            <div class="banner_text">
                                <small class="uppercase animated fadeInUpShort slow">Ride with
                                    Confidence</small>
                                <h1 class="animated fadeInUpShort slow delay-250">
                                    <span> Book Now with C2C </span>
                                </h1>
                                <p class="uppercase animated fadeInUpShort slow delay-500">Make your move today with Comfort & reliability.</p>
                                </p>
                            </div>
                        </div>
                ...
                <div class="autoContent">
                    <div class="our_value_inner animatedParent animateOnce">
                        <div class="ov_left">
                            <div class="headlines">
                                <span class="headlines_sub headlines_leftStar animated fadeInUpShort slow">Our
                                    Values</span>
                                <h2 class="animated fadeInUpShort slow delay-250">Wherever You Are, We've Got Your Back.</h2>  
                            </div>
                                ...
                                <ul class="d_block">
                                    <li class="animated fadeInUpShort slow delay-500 w_100">
                                        <div class="r_c2c_left_info">
                                            <h4>Be Dependable</h4>
                                            <p>Count on us to get you there, every time. Punctuality and trust are at our core.</p>
                                        </div>
                                    </li>
                                    <li class="animated fadeInUpShort slow delay-500 w_100">
                                        <div class="r_c2c_left_info">
                                            <h4>Keep Improving</h4>
                                            <p>We listen. We adapt. We grow - so your experience keeps getting better.</p>
                                        </div>
                                    </li>
                                    <li class="animated fadeInUpShort slow delay-500 w_100">
                                        <div class="r_c2c_left_info">
                                            <h4>Care Like Family</h4>
                                            <p>From our chauffeurs to our guests, every ride is a promise of care, comfort, and class.</p>
                                        </div>
                                    </li>
                                    ...
                                    <li class="animated fadeInUpShort slow delay-500 w_100">
                                        <div class="r_c2c_left_info">
                                            ...
                                            <p>We keep things fresh with the latest tech and ideas so your rides are always smooth, stylish, and stress-free.</p>
                                        </div>
                                    </li>
                                    <li class="animated fadeInUpShort slow delay-500 w_100">
                                        <div class="r_c2c_left_info">
                                            <h4>Comfort Comes First</h4>
                                            <p>From the car you choose to the care we provide, everything is designed to make your journey easy and enjoyable.</p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="ov_right animated fadeInRight">
                            <figure>
                                <img src="{{ asset('front/images/our_values_right_img.png') }}" alt="#">
                            </figure>
                        </div>
                    </div>
                                    ...
                                    <div class="accordion_item active">
                                        ...
                                        <div class="accordion_body" style="display: block;">
                                            <div class="accordion_content">
                                                <p>C2C serves across the UAE, covering major cities and regions with luxurious rides tailored to your needs.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion_item">
                                        <div class="accordion_header">
                                            <strong>(Q) Can I Book a Ride for Multiple Hours?</strong>
                                            <span class="plus_icon"></span>
                                        </div>
                                        <div class="accordion_body">
                                            <div class="accordion_content">
                                                <p>Absolutely! Whether it's a short trip or an all-day service, we've got you covered.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion_item">
                                        <div class="accordion_header">
                                            <strong>(Q) What Vehicles Are Available?</strong>
                                            <span class="plus_icon"></span>
                                        </div>
                                        <div class="accordion_body">
                                            <div class="accordion_content">
                                                <p>From premium sedans to spacious SUVs, our fleet is designed to match every occasion and preference. </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion_item">
                                        <div class="accordion_header">
                                            <strong>(Q) Are Airport Pickups and Drop-offs Available?</strong>
                                            <span class="plus_icon"></span>
                                        </div>
                                        <div class="accordion_body">
                                            <div class="accordion_content">
                                                <p>Yes! We specialize in on-time, hassle-free airport rides to ensure you travel without stress.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion_item">
                                        <div class="accordion_header">
                                            <strong>(Q) How Can I Book a Ride?</strong>
                                            <span class="plus_icon"></span>
                                        </div>
                                        <div class="accordion_body">
                                            <div class="accordion_content">
                                                <p>Simply enter your pickup/drop-off details on our website or app, choose your vehicle, and enjoy the ride!</p>
                                            </div>
                                        </div>
                                    </div> 
                                </div>
                                    ...
                                    <div class="comments_slider">
                                            ...
                                            <div class="comments_box">
                                                <div class="comments_box_inner">
                                                    <div class="comments_box_data">
                                                        <p>I've never felt this cared for during a ride. C2C's attention to detail and comfort is unmatched.</p>
                                                    </div>
                                        ...
                                        <div>
                                            <div class="comments_box">
                                                <div class="comments_box_inner">
                                                    <div class="comments_box_data">
                                                        <p>The booking process is so simple, and the rides are luxurious without breaking the bank. Highly recommended!</p>
                                                    </div>
                                                    <div class="comments_box_user">
                                                        <a href="javascript:void(0);">
                                                            <i>
                                        ...
                                        <div>
                                            <div class="comments_box">
                                                <div class="comments_box_inner">
                                                    <div class="comments_box_data">
                                                        <p>Punctual, professional, and premium. What more could you ask for?</p>
                                                    </div>
                                                    <div class="comments_box_user">
                                                        <a href="javascript:void(0);">
                                                            <i>
                                        ...
                                        <div>
                                            <div class="comments_box">
                                                <div class="comments_box_inner">
                                                    <div class="comments_box_data">
                                                        <p>C2C provides a premium service at affordable prices. It's my go-to choice whenever I need a reliable ride.</p>
                                                    </div>
                                                    <div class="comments_box_user">
                                                        <a href="javascript:void(0);">
                                                            <i>
