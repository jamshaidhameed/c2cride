...
@section('meta')
<meta name="description" content="Book your airport rides, city tours, or intercity transfers with C2C Rides. Safe, reliable, and affordable taxi service in Dubai & UAE.
" />
@endsection
@section('title')
 Affordable Chauffeur & Taxi Services in Dubai | C2C Rides
@endsection
@section('content')
<div class="content">
                    ...
                    <div class="banner_box">
                        ...
                        <div class="banner_text">
                            ...
                            <h1 class="animated fadeInUpShort slow delay-250">
                                Enhance your experience<br> By

                                <span class="banner_text_slider">
                                    <span style="display: block;">The Rides </span>
                                    <span style="display: none;">The hours </span>
                                    <span style="display: none;">City Tour</span>
                                    <i></i>
                                </span>

                            </h1>
                            <p class="animated fadeInUpShort slow delay-500">Where every ride is yours to command, Whether you need on-demand rides, hourly booking, city tour, we got you covered !! <br>
                                Ride in comfort, explore with ease, and travel your way in peace
                                        ...
                                        <ul>
                                            <li class="animated fadeInUpShort slow">
                                                <a href="{{ route('rides.page') }}" class="os_info">
                                                    ...
                                                    <div class="os_info_data">
                                                        <h4>Rides</h4>
                                                        <p>Comfortable and reliable transportation at your fingertips</p>
                                            ...
                                            <li class="animated fadeInUpShort slow delay-250">
                                                <a href="{{ route('airport.rides.page') }}" class="os_info">
                                                    ...
                                                    <div class="os_info_data">
                                                        <h4>Airport Rides</h4>
                                                        <p>Seamless, punctual, and stress-free airport rides</p>
                                                        <span class="view_link">Book Now</span>
                                                    </div>
                                                </a>
                                            </li>
                                            <li class="animated fadeInUpShort slow delay-500">
                                                <a href="{{ route('city.tour.page') }}" class="os_info">
                                                    ...
                                                    <div class="os_info_data">
                                                        <h4>City Tour</h4>
                                                        <p>Discover the beauty and culture of the UAE Emirates with our experienced chauffeurs.</p>
                                                        <span class="view_link">Book Now</span>
                                                    </div>
                                                </a>
                                            </li>
                                            <li class="animated fadeInUpShort slow delay-750">
                                                <a href="{{ route('business.ride') }}" class="os_info">
                                                    ...
                                                    <div class="os_info_data">
                                                        ...
                                                        <p>Executive rides solution  designed for efficiency and professionalism.</p>
                                                        <span class="view_link">Book Now</span>
                                                    </div>
                                                </a>
                                            </li>
                                            <li class="animated fadeInUpShort slow delay-250">
                                                <a href="{{ url('car/rentals') }}" class="os_info">
                                                    ...
                                                    <div class="os_info_data">
                                                        ...
                                                        <p>Travel in style and comfort with our premium vehicle collection.</p>
                                                        <span class="view_link">Book Now</span>
                                                    </div>
                                                </a>
                                            </li>
                        ...
                        <div class="autoContent">
                            <div class="iconicSecInner animatedParent animateOnce">
                                <div class="headlines headlines_white animatedParent animateOnce">
                                    ...
                                    <h2 class="fadeInUpShort animated slow delay-250">Discover All the Iconic Destinations in UAE
                                    </h2>
                                    ...
                                    <div class="iconic_slider ">
                                        <div class="iconic_slide_run">
                                            <a href="{{ route('abudhabi.tour.page') }}" class="iconic_box"> 
                                                <div class="iconicImg">
                                                    <img src="{{ asset('front/images/iconicImg1.png') }}" alt="#">
                                                </div>
                                                <div class="iconic_pos">
                                                    <div class="iconic_pos_content">
                                                        <h4>Abu Dhabi</h4>
                                                        <p>Smooth journeys through the UAE's green capital, connecting you to its historical and iconic mosques, islands, and entertainment venues.</p>
                                                        <div class="iconic_show">
                                                            <ul>
                                                                <li><span>Sheikh Zayed Grand Mosque</span></li>
                                                                <li><span>Louvre Abu Dhabi</span>
                                                                </li>
                                                                <li><span>Qasr Al Watan</span>
                                                                </li>
                                                                <li><span>Ferrari World</span></li>
                                                                <li><span>Yas Marina Circuit</span></li>
                                                                <li><span>Emirates Palace</span></li>
                                                                <li><span>Corniche Beach</span></li> 
                                                            </ul>
                                                        </div>
                                                    </div>
                                                    <div class="iconic_ratingRow">
                                                        <span>Starting: AED 699</span>
                                                        <small>
                                                            4.6 (500)
                                                        </small>
                                                    </div>
                                        ...
                                        <div class="iconic_slide_run">
                                            <a href="{{ route('dubai.tour.page') }}" class="iconic_box">
                                                <div class="iconicImg">
                                                    <img src="{{ asset('front/images/new-dubai.jpg') }}" alt="#">
                                                </div>
                                                <div class="iconic_pos">
                                                    <div class="iconic_pos_content">
                                                        <h4>Dubai</h4>
                                                        <p>Reliable rides through the UAE's most vibrant city, connecting you to iconic landmarks and business districts.</p>
                                                        <div class="iconic_show">
                                                            <ul>
                                                                <li><span>Burj Khalifa</span></li>
                                                                <li><span>Dubai Mall</span>
                                                                </li>
                                                                <li><span>Palm Jumeirah</span>
                                                                </li>
                                                                <li><span>Dubai Marina</span></li>
                                                                <li><span>Dubai Creek</span></li>
                                                                <li><span>Dubai Frame</span>
                                                                </li>
                                                                <li><span>Miracle Garden</span></li> 
                                                            </ul>
                                                        </div>
                                                    </div>
                                                    <div class="iconic_ratingRow">
                                        ...
                                        <div class="iconic_slide_run">
                                            <a href="{{ route('sharjah.tour.page') }}" class="iconic_box">
                                                <div class="iconicImg">
                                                    <img src="{{ asset('front/images/new-sharjah.jpg') }}" alt="#">
                                                </div>
                                                <div class="iconic_pos">
                                                    <div class="iconic_pos_content">
                                                        <h4>Sharjah</h4>
                                                        <p>Connect to museums, souks, and universities in the cultural emirate with our dedicated chauffeurs.</p>
                                                        <div class="iconic_show">
                                                            <ul>
                                                                <li><span>Sharjah Art Museum</span></li>
                                                                <li><span>Sharjah Museum of Islamic Civilization</span>
                                                                </li>
                                                                <li><span>Al Noor Mosque</span>
                                                                </li>
                                                                <li><span>Al Majaz Waterfront</span></li>
                                                                <li><span>Al Qasba</span></li>
                                                                <li><span>Sharjah Aquarium</span></li>
                                                                <li><span>Mleiha Archaeological Centre</span></li>
                                        ...
                                        <div class="iconic_slide_run">
                                            <a href="{{ route('ajam.tour.page') }}" class="iconic_box">
                                                <div class="iconicImg">
                                                    <img src="{{ asset('front/images/new-ajam.jpg') }}" alt="#">
                                                </div>
                                                <div class="iconic_pos">
                                                    <div class="iconic_pos_content">
                                                        <h4>Ajman</h4>
                                                        <p>Experience Ajman's blend of tradition and modernity with our comfortable car rides</p>
                                                        <div class="iconic_show">
                                                            <ul>
                                                                <li><span>Ajman Beach</span></li>
                                                                <li><span>Ajman Museum</span>
                                                                </li>
                                                                <li><span>Al Zorah Nature Reserve</span>
                                                                </li>
                                                                <li><span>Dhow Yard</span></li>
                                                                <li><span>Ajman Corniche</span></li>
                                                                <li><span>Sheikh Zayed Mosque Ajman</span></li>
                                                                <li><span>Al Murabaa Watchtower</span></li>
                                        ...
                                        <div class="iconic_slide_run">
                                            <a href="{{ route('umm.al.quwain.tour.page') }}" class="iconic_box">
                                                <div class="iconicImg">
                                                    <img src="{{ asset('front/images/iconicImg5.png') }}" alt="#">
                                                </div>
                                                <div class="iconic_pos">
                                                    <div class="iconic_pos_content">
                                                        <h4>Umm Al Quwain</h4>
                                                        <p>Convenient car service in this peaceful coastal emirate, perfect for both leisure and business travel.</p>
                                                        <div class="iconic_show">
                                                            <ul>
                                                                <li><span>Dreamland Aqua Park</span></li>
                                                                <li><span>Umm Al Quwain Fort and Museum</span>
                                                                </li>
                                                                <li><span>Al Sinniyah Island</span>
                                                                </li>
                                                                <li><span>Marine Club</span></li>
                                                                <li><span>UAQ National Museum</span></li>
                                                                <li><span>Khor Al Beidah Mangroves</span></li>
                                                                <li><span>Al Dour Archaeological Site</span></li>
                                        ...
                                        <div class="iconic_slide_run">
                                            <a href="{{ route('ras.al.khaimah.tour.page') }}" class="iconic_box">
                                                <div class="iconicImg">
                                                    <img src="{{ asset('front/images/iconicImg6.png') }}" alt="#">
                                                </div>
                                                <div class="iconic_pos">
                                                    <div class="iconic_pos_content">
                                                        <h4>Ras Al Khaimah</h4>
                                                        <p>Convenient transportation to mountains, water parks, and historic sites in this northern city.</p>
                                                        <div class="iconic_show">
                                                            <ul>
                                                                <li><span>Jebel Jais</span></li>
                                                                <li><span>Dhayah Fort</span>
                                                                </li>
                                                                <li><span>Al Hamra Village</span>
                                                                </li>
                                                                <li><span>Ras Al Khaimah National Museum</span></li>
                                                                <li><span>Al Marjan Island</span></li>
                                                                <li><span>Khatt Springs</span></li>
                                                                <li><span>Rak beach</span></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                    <div class="iconic_ratingRow">
                                        ...
                                        <div class="iconic_slide_run">
                                            <a href="{{ route('fujairah.tour.page') }}" class="iconic_box">
                                                <div class="iconicImg">
                                                    <img src="{{ asset('front/images/new-fujera.jpg') }}" alt="#">
                                                </div>
                                                <div class="iconic_pos">
                                                    <div class="iconic_pos_content">
                                                        <h4>Fujairah</h4>
                                                        <p>Professional car service across the eastern coast, ensuring timely arrivals, whether for business or tourism.</p>
                                                        <div class="iconic_show">
                                                            <ul>
                                                                <li><span>Al-Bidyah Mosque</span></li>
                                                                <li><span>Fujairah Fort</span>
                                                                </li>
                                                                <li><span>Snoopy Island</span>
                                                                </li>
                                                                <li><span>Fujairah Museum</span></li>
                                                                <li><span>Sheikh Zayed Mosque Fujairah</span></li>
                                                                <li><span>Wadi Wurayah National Park</span></li>
                                                                <li><span>Kalba Corniche Park</span></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                    <div class="iconic_ratingRow">
