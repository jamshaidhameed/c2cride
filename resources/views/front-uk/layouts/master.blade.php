...
<meta name="google-site-verification" content="fP1oj8DKF5A2mykOFWXFPhFOSusdBrJUWv44_N6-GI4" />

<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-QL4CSNJ3ZN"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-QL4CSNJ3ZN');
</script>
