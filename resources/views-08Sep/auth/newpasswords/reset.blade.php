                                   ...
                                   <div class="form_row">
                                    <div class="form_cell">
                                        <div class="form_field">
                                            ...
                                            <input type="email" name="email" class="floating-input @error('email') error_stroke @enderror" placeholder="Enter Your Email" value="{{ !empty($forgot_password) ? $forgot_password->email :  old('email') }}"/>
