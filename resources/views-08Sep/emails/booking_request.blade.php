    ...
    <tr>
        ...
        <td width="540">
            <table width="100%" cellpadding="0" cellspacing="0" >
                ...
                <tr><td style="font-size: 15px; line-height: 140%; font-weight: 600; color: #000; text-align: center;">Booking Request</td></tr>
                <tr><td height="20"></td></tr>
                ...
                <tr><td style="font-size: 13px; line-height: 140%; font-weight: 400; color: #000;">Your Booking request has been received, Please allow our team some time to confirm your ride.</td></tr>
                <tr><td height="20"></td></tr>
                <tr><td style="font-size: 13px; line-height: 140%; font-weight: 500; color: #000;"><img src="{{asset('images/ride_icon.png')}}" alt=""> &nbsp; Ride Request #{{$ride->booking_code}}  {{$ride->way == '2'?'& '.$ride->return_booking_code:''}} </td></tr>
                ...
                <tr>
                    <td>
                        <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #EDEDED; padding: 15px;">
                            ...
                            <tr>
                                    <td width="50%" style="font-size: 13px; padding: 8px 10px 8px 0px; border-top: 1px solid #A0A0A0; border-bottom: 1px solid #A0A0A0; border-right: 1px solid #A0A0A0; line-height: 140%; font-weight: 500; color: #000000;">{{ date('D, M d', strtotime($ride->date_time)) }}<br>{{ date('h:i A', strtotime($ride->date_time)) }}</td>
                                @if($ride->way == '2')
                                <td width="50%" style="font-size: 13px; padding: 8px 0px 8px 10px;  border-top: 1px solid #A0A0A0; border-bottom: 1px solid #A0A0A0; line-height: 140%; font-weight: 500; color: #000000;">{{ date('D, M d', strtotime($ride->return_time)) }}<br>{{ date('h:i A', strtotime($ride->return_time)) }}</td>
                                @endif
                            </tr>
                            <tr><td height="10"></td></tr>
                            <tr>
                            ...
                            <tr><td height="5"></td></tr>
                             <tr>
                                <td  style="font-size: 13px; line-height: 140%; font-weight: 400; color: #575757;">
                                    <a href="{{ route('ride.track') }}" style="color: #333333;background-color:#eeeeee;border: 1px solid #0fa85c;display: inline-flex;align-items: center;cursor: pointer;border-radius: 5px;padding: 0.6875em 0.75em;gap: 6px;transition: all 0.3s ease;font-weight: 600;">Track your Ride</a>
                                </td>
                            </tr>
                            <!-- <tr>
                ...
                <tr><td height="30"></td></tr>
                <tr><td style="font-size: 13px; line-height: 140%; font-weight: 400; color: #000;">You can simply check the status on the website or you will shortly receive an email for the confirmation.</td></tr>
