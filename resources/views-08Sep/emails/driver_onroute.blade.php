    ...
    <tr>
        ...
        <td width="540">
            <table width="100%" cellpadding="0" cellspacing="0" >
                ...
                <tr><td style="font-size: 15px; line-height: 140%; font-weight: 600; color: #000; text-align: center;">Booking Confirmed</td></tr>
                <tr><td height="20"></td></tr>
                <tr><td style="font-size: 13px; line-height: 140%; font-weight: 400; color: #000;">Hi {{ $ride->display_name }},</td></tr>
                <tr><td style="font-size: 13px; line-height: 140%; font-weight: 400; color: #000;">Your captain is enroute , will arrive at the scheduled time.</td></tr>
                <tr><td height="20"></td></tr>
                    ...
                    <td>
                        <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #EDEDED; padding: 15px;">
                                ...
                                <td colspan="2">
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td  style="font-size: 13px; line-height: 140%; font-weight: 500; color: #000000;">{{ $ride->destination }}</td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td style="font-size: 13px; line-height: 140%; font-weight: 400; text-align: right; color: #575757;">
                                    @if($ride->ride_type_id==1)
                                        <img src="{{asset('images/city_icon.png')}}" alt="">City 2 City
                                    @elseif($ride->ride_type_id==2)
                                     <img src="{{asset('images/city_icon.png')}}" alt=""> Airport Ride
                                    @elseif($ride->ride_type_id==3)
                                      <img src="{{asset('images/ride_icon.png')}}" alt=""> City Tour
                                    @elseif($ride->ride_type_id==4)
                                      <img src="{{asset('images/driver_link_icon.png')}}" alt=""> Personal Driver
                                    @endif
                                </td>
                            </tr>
                            <tr><td height="15"></td></tr>
                            <tr>
                                ...
                                <td style="font-size: 13px; line-height: 140%; font-weight: 400; text-align: right; color: #000000;">{{$ride->adults + $ride->children}}x</td>
                            </tr>
                            <tr><td height="5"></td></tr>
                            <tr>
