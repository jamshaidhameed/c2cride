    ...
    <tr>
        ...
        <td width="540">
            <table width="100%" cellpadding="0" cellspacing="0" >
                <tr><td><img src="{{asset('images/booking_cancelled_icon.png')}}" alt="" style="max-width: 100%; display: block; margin: auto;"></td></tr>
                <tr><td height="20"></td></tr>
                <tr><td style="font-size: 15px; line-height: 140%; font-weight: 600; color: #000; text-align: center;">Booking Cancelled</td></tr>
                ...
                <tr><td style="font-size: 13px; line-height: 140%; font-weight: 400; color: #000;">We have cancelled your Booking request, if there are any issues please let us know, we are open to improvements.</td></tr>
                <tr><td height="20"></td></tr>
                ...
                <tr>
                    <td>
                        <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #FFE9E6; padding: 15px;">
                            <tr>
                        ...
                        @if(!empty($ride->cancel_remarks))
                         <p style="#E62525;">Ride Cancel Reasons</p>
                         <ol>
                            @foreach (explode(",",$ride->cancel_remarks) as $item)
                                <li>{{ $item }}</li>
                            @endforeach
                         </ol>
                        @endif
                ...
                <tr><td height="30"></td></tr>
                {{-- <tr><td style="font-size: 13px; line-height: 140%; font-weight: 400; color: #000;">See you later.</td></tr> --}}
