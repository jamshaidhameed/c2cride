...
@section('meta')
 <meta name="description" content="Explore the beautiful city of Fujairah with our professional chauffeur-guided tour packages. Book your ride now." />
@endsection
@section('title')
 Fujairah City Tour from Dubai | C2C Rides UAE
@endsection
@section("content")
<div class="content">
    <div class="gradiantParent">
        <div class="gradiantChild">
            <div class="auto_banner ct_fujairah_banner animatedParent animateOnce">
                <div class="autoContent">
                    <div class="banner_inner">
                        <div class="banner_box">
                            <div class="banner_text">
                                <small class="uppercase animated fadeInUpShort slow">Fujairah</small>
                                <h1 class="animated fadeInUpShort slow delay-250">
                                    Explore the Hidden Gem – <span>Fujairah</span> Tour
                    ...
                    <div class="our_value_inner animatedParent animateOnce">
                                ...
                                <ul>
                                    <li>
                                        <div class="ov_galary_img">
                                            <img src="{{ asset('front/images/ov_galary_img13.png') }}" alt="#">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="ov_galary_img">
                                            <img src="{{ asset('front/images/ov_galary_img14.png') }}" alt="#">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="ov_galary_img">
                                            <img src="{{ asset('front/images/ov_galary_img15.png') }}" alt="#">
                                        </div>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="ov_left">
                            <div class="headlines">
                                ...
                                <p class="animated fadeInUpShort slow delay-500">Escape to the serene landscapes of Fujairah, where history meets nature. Travel with ease to its forts, mountains, and coastal retreats with our reliable transportation.</p>
                            </div>
                                ...
                                <ul>
                                    <li class="animated fadeInUpShort slow delay-500 w_100">
                                        ...
                                        <div class="r_c2c_left_info">
                                            <h4>Exclusive Fujairah Tour:</h4>
                                            <p> Explore Fujairah’s most iconic sites, including the stunning Fujairah Fort and the peaceful Al Bidya Mosque, while experiencing the perfect blend of natural beauty and cultural heritage.</p>
                                        </div>
                                    </li>
                                    <li class="animated fadeInUpShort slow delay-500 w_100">
                                        <div class="ct_exclusive_icon">
                                        ...
                                        <div class="r_c2c_left_info">
                                            ...
                                            <p>Our expert guides will take you through Fujairah’s rich history, from its ancient traditions to its transformation into a modern city, offering fascinating insights in multiple languages and revealing hidden gems that showcase the city’s vibrant story.</p>
                                        </div>
                                    </li>
                        ...
                        <div class="visit_places_slider_main">
                            <div class="visit_places_slider">
                                <div>
                                    <div class="vp_slider_box">
                                        <div class="vp_slider_img">
                                            <img src="{{ asset('front/images/vp_fujairah_fort.png') }}" alt="#">
                                        </div>
                                        <div class="vp_slider_text">
                                            <span>Fujairah Fort</span>
                                        </div>
                                    </div>
                                </div>
                                <div>
                                    <div class="vp_slider_box">
                                        <div class="vp_slider_img">
                                            <img src="{{ asset('front/images/vp_bidya_masjid.png') }}" alt="#">
                                        </div>
                                        <div class="vp_slider_text">
                                            <span>Al Bidya Mosque Fujairah</span>
                                        </div>
                                    </div>
                                </div>
                                <div>
                                    <div class="vp_slider_box">
                                        <div class="vp_slider_img">
                                            <img src="{{ asset('front/images/vp_fujairah_beach.png') }}" alt="#">
                                        </div>
                                        <div class="vp_slider_text">
                                            <span>Beach</span>
                                        </div>
                                ...
                                <div>
                                    <div class="vp_slider_box">
                                        <div class="vp_slider_img">
                                            <img src="{{ asset('front/images/vp_fujairah_museum.png') }}" alt="#">
                                        </div>
                                        <div class="vp_slider_text">
                                            <span>Fujairah Museum</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion">
                                    <div class="accordion_item active">
                                        <div class="accordion_header">
                                            <strong>(Q) In which aspects is Fujairah different from other Emirates of the UAE?</strong>
                                            <span class="plus_icon"></span>
                                        </div>
                                        <div class="accordion_body" style="display: block;">
                                            <div class="accordion_content">
                                                <p>Unlike other Emirates of the UAE, Fujairah is positioned entirely along the Gulf of Oman rather than the Persian Gulf. This differentiates it in terms of marine ecosystems, mountains, and a peaceful environment compared to the bustling west coast. </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion_item">
                                        <div class="accordion_header">
                                            <strong>(Q) Can C2CRides organize multi-day tours of Fujairah?</strong>
                                            <span class="plus_icon"></span>
                                        </div>
                                        <div class="accordion_body">
                                            <div class="accordion_content">
                                                <p>Indeed! We craft multi-day plans with seamless hotel pick-ups, a full-day guided tour, and options for nights spent in mountain cabins or beachfront resort hotels.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion_item">
                                        <div class="accordion_header">
                                            <strong>(Q) Is Fujairah tied to any adventurous activities?</strong>
                                            <span class="plus_icon"></span>
                                        </div>
                                        <div class="accordion_body">
                                            <div class="accordion_content">
                                                <p>Yes, it is known as the UAE's adventure hub. From hiking to mountain biking to rock climbing, diving, snorkeling, and a variety of water sports, it truly has everything. Our drivers will ensure you get the best reputable adventure suppliers in the area for your convenience. </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion_item">
                                        <div class="accordion_header">
                                            <strong>(Q) Do C2CRides offer photography tours of Fujairah?</strong>
                                            <span class="plus_icon"></span>
                                        </div>
                                        <div class="accordion_body">
                                            <div class="accordion_content">
                                                <p>Of course! With expert drivers, we provide tours tweaked for photography purposes who know the best places to capture the most stunning views, ranging from mountain passes to ancient forts, along with the required lighting.  </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion_item">
                                        <div class="accordion_header">
                                            <strong>(Q) What is the distance between Fujairah and Dubai, and do you provide transfers from city to city?</strong>
                                            <span class="plus_icon"></span>
                                        </div>
                                        <div class="accordion_body">
                                            <div class="accordion_content">
                                                <p>Fujairah is about a 2-hour drive from Dubai. C2CRides make your ride much more convenient and allow you to skip the hassle of intercity transport. Your ride can include some enjoyable sightseeing spots. </p>
                                            </div>
                                        </div>
                                    </div>
                                    {{-- <div class="accordion_item">
