...
@section('content')
 <div class="content">
            <div class="vehicleSec gradiantParent safariBookingMain">
                            ...
                            <div class="autoContent">
                                <div class="vehicle_content_inner">
                                    <div class="vc_left">
                                        ...
                                        <div class="bookingDetailsMain safariBookingMain">
                                            <div class="vc_left_content">
                                                ...
                                                <div class="bookingDetailsList_sec">
                                                    <div class="animatedParent animateOnce bookingDetailsList_title">
                                                        <h2 class="animated fadeInUpShort slow">Book a Safari</h2>
                                                    </div>
                                                    <div class="animatedParent animateOnce">
                                                        <ul class="bookingCardUl animated fadeInUpShort slow">
                                                            @foreach ($packages as $package)
                                                                ...
                                                                <div class="v_card">
                                                                    <div class="discountText">
                                                                        <span>@if($package->discount > 0 && $package->apply_discount == 1){{ $package->discount }}% OFF @endif</span>
                                                                    </div>
                                                                    <div class="v_card_inner">
                                                                        <div class="v_card_left">
                                                                            <div class="v_card_left_box">
                                                                                <h4>{{ ucwords($package->category) }}</h4>
                                                                                <div class="v_card_sliderBox">
                                                                                    <div class="v_card_sliderBox_li">
                                                                                        <div class="v_card_left_img">
                                                                                            <img src="{{ asset('front/safari/images/'.$package->image) }}"
                                                                                                alt="#">
                                                                                        </div>
                                                                                    </div>
                                                                        ...
                                                                        <div class="v_card_middle">
                                                                            <div class="v_card_middle_title">
                                                                                <h4> {{ ucwords($package->name ) }}</h4>
                                                                                {{-- <a href="javascript:void(0)"
                                                                                    class="all_btn red_btn sfariBookDetail_btn">View
                                                                                    Details</a> --}}
                                                                            </div>
                                                                            @php  $passengers = $package->persons;
                                                                                  $total_passengers = $data["total_passengers"];
                                                                                  $quantity = 1;
                                                                                  $discounted_price = 0;
                                                                                  if ($total_passengers > $passengers && $passengers > 0) {
                                                                                    
                                                                                    $quantity = round($total_passengers / $passengers);
                                                                                 }

                                                                                 $ride_price = $package->price * $quantity;

                                                                                  if ($package->discount > 0 && $package->apply_discount == 1) {
                                                                                    
                                                                                    $discount_amount = (float) $ride_price * (float) $package->discount / 100;

                                                                                    $discounted_price = (float) $ride_price - $discount_amount;
                                                                                  }

                                                                                 
                                                                            @endphp
                                                                            <input type="hidden" name="discount_amount" value="{{ $package->discount}}">
                                                                            <input type="hidden" name="apply_discount" value="{{ $package->apply_discount }}">
                                                                            <input type="hidden" name="ride_price" value="{{ $ride_price }}">
                                                                            <input type="hidden" name="id" value="{{ $package->id }}">
                                                                            <input type="hidden" name="ride_type_id" value="{{ session('safari_step_one_data')['ride_type_id'] }}">
                                                                            <ul>
                                                                                ...
                                                                                <li>
                                                                                    <div class="v_card_spec">
                                                                                        @if(!empty($package->free_waiting_time))
                                                                                        <i>
                                                                                        ...
                                                                                        <span>{{ $package->free_waiting_time}}<span
                                                                                                class="hideOnMobile">-Free</span>
                                                                                            Waiting</span>
                                                                                        @endif
                                                                                    </div>
                                                                                </li>
                                                                                ...
                                                                                <li class="hideOnMobile">
                                                                                    <div class="v_card_spec">
                                                                                        ...
                                                                                        <span>@if($package->type == "per_person")Per Person: <strong>AED
                                                                                                {{ number_format($package->price,2) }}</strong> @else {{ $package->persons}} Persons @endif</span>
                                                                                    </div>
                                                                                </li>
                                                                                <li class="hideOnMobile">
                                                                                    <div
                                                                                        class="sfariBookIncreament_row">

                                                                                        <div
                                                                                            class="sfariBookIncreament_inner">
                                                                                            <!-- <label>Price Per
                                                                                                Pass</label> -->
                                                                                            <div
                                                                                                class="increment-box sb_increament_box">
                                                                                                <button
                                                                                                    class="decrement_icon sb_decrement_btn">-</button>
                                                                                                <input type="number"
                                                                                                    class="floating-input number-input quantity-{{$package->id}}" name="quantity"
                                                                                                    placeholder="0"
                                                                                                    value="{{ $quantity }}" min="0">
                                                                                                <button
                                                                                                    class="increment_icon sb_increament_btn">+</button>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </li>
                                                                        ...
                                                                        <div class="v_crad_right">
                                                                            <div class="v_card_priceBox">
                                                                                <div class="sfariBook_priceBox_parent">
                                                                                    <!-- mobile view of sfari book increament section -->
                                                                                    <div
                                                                                        class="sfariBook_increamentBox_mobile">
                                                                                        <div class="v_card_spec">
                                                                                            <span>per person:
                                                                                                <strong>AED
                                                                                                    {{ number_format($package->price,2) }}</strong></span>
                                                                                        </div>
                                                                                        <div
                                                                                            class="sfariBookIncreament_inner">
                                                                                            <div
                                                                                                ...
                                                                                                <button
                                                                                                    class="decrement_icon sb_decrement_btn">-</button>
                                                                                                <input type="number"
                                                                                                    class="floating-input number-input" name="quantity-{{$package->id}}"
                                                                                                    placeholder="0"
                                                                                                    value="{{ $quantity }}" min="0">
                                                                                                <button
                                                                                                    class="increment_icon sb_increament_btn">+</button>
                                                                                    ...
                                                                                    <div class="v_card_priceBox_text">
                                                                                        <h4>Total one-way price</h4>
                                                                                        @if($package->discount > 0 && $package->apply_discount == 1)
                                                                                        <strong class="original-price-{{ $package->id}}">{{ number_format($ride_price,2)}} AED</strong>
                                                                                        @else 
                                                                                        <strong class="original-price-{{ $package->id}}"></strong>
                                                                                        @endif
                                                                                        <h2 class="discounted-price-{{ $package->id}}">{{ $discounted_price == 0 ? $ride_price : $discounted_price }} AED</h2>
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <input type="hidden" name="discount_amount" class="discount_amount-{{$package->id}}" value="{{ $package->discount}}">
                                                                                    <input type="hidden" class="apply_discount-{{$package->id}}" name="apply_discount" value="{{ $package->apply_discount }}">
                                                                                    <input type="hidden" class="ride_price-{{$package->id}}" name="ride_price" value="{{ $ride_price }}">
                                                                                    <input type="hidden" class="single_price-{{$package->id}}" name="single_price" value="{{ $package->price }}">
                                                                                    <input type="hidden" class="discounted_price-{{$package->id}}" name="discounted_price" value="{{ $discounted_price }}">
                                                                                    <a href="javascript:void(0)"
                                                                                        class="all_btn bookSfariSelectBtn" data-id="{{ $package->id }}">Select</a>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="v_card_btn vCardChangeVehicleRow">
                                                                        <a href="javascript:void(0)"
                                                                            class="all_btn w_100 uppercase bookSfariChangeVehicleBtn">change
                                                                            vehicle</a>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            ...
                                                            @endforeach
                                                            <input type="hidden" name="selected_package_id" value="">
                                                            <input type="hidden" name="selected_quantity" value="">

                                                        </ul>
                                                    </div>
                                                </div>

                                                <!-- step 1 additional add ons -->
                                                <div class="additionalOns_offsetter"></div>
                                                <div class="additionalOns_sec">
                                                    <div class="additionalOns_titleRow">
                                                        <h2>Additional Add-ons</h2>
                                                        <div class="editAddOnsBtnOuter">
                                                            <button type="button"
                                                                class="all_btn icon_btn uppercase outlined_green_btn editAddOnsBtn">
                                                                <i>
                                                    ...
                                                    <div class="additionalOns_inner">
                                                        <!-- add ons boxes row -->
                                                        @foreach ($addons as $add)
                                                           <div class="additionalOns_row addon-{{ $add->id }}">
                                                            <div class="additionalOns_box">
                                                                <div class="additionalOns_img">
                                                                    <figure>
                                                                        <img src="{{ asset('front/safari/images/'.$add->image) }}" alt="#">
                                                                    </figure>
                                                                </div>
                                                                <div class="additionalOns_right">
                                                                    <h3>{{ $add->title }}</h3>
                                                                     {!! html_entity_decode($add->description)  !!}

                                                                    <div class="additionalOns_footer">
                                                                        <div class="additionalOns_footerPrice">
                                                                            @php $add_on_price = $add->price;
                                                                                 $discount_amount = $add->discount;
                                                                                 $apply_discount = $add->apply_discount;
                                                                                 $discounted_amount = 0;
                                                                                 if ($discount_amount > 0 && $apply_discount == 1) {
                                                                                    $discount = $add_on_price * $discount_amount / 100;
                                                                                    $discounted_amount = round($add_on_price - $discount,2);
                                                                                 }
                                                                                
                                                                            @endphp
                                                                            <input type="hidden" name="add_on_discount-{{ $add->id }}" value="{{ $discount_amount }}">
                                                                            <input type="hidden" name="add_on_price-{{ $add->id }}" value="{{ $add_on_price }}">
                                                                            <input type="hidden" name="apply_discount-{{ $add->id }}" value="{{ $add->apply_discount }}">
                                                                            <strong class="add-on-discounted-price-{{ $add->id }}">@if($discounted_amount > 0 ) {{ number_format($discounted_amount,2) }} @else {{ number_format($add_on_price,2) }} @endif AED</strong>
                                                                            <span class="add-on-original-price-{{ $add->id }}">@if($discounted_amount > 0) AED {{ number_format($add_on_price,2)}} @endif</span>
                                                                        </div>
                                                                        <div class="additionalOns_footerRight">
                                                                            <div class="additionalOns_btnRow">
                                                                                <a
                                                                                    class="additionalOns_btn all_btn btn_large" data-id="{{ $add->id}}">
                                                                                    <span class="mr_auto">ADD</span>
                                                                                </a>
                                                                            </div>
                                                                            <div
                                                                                class="increment-box additionalOns_increament_box">
                                                                                <button
                                                                                    class="decrement_icon sb_decrement_btn">-</button>
                                                                                <input type="number"
                                                                                    class="floating-input number-input add-on-quantity"
                                                                                    placeholder="0" value="1" min="0" name="add-on-quantity-{{ $add->id}}">
                                                                                <button
                                                                                    class="increment_icon sb_increament_btn">+</button>
                                                                            </div>
                                                                        </div>
                                                    ...
                                                    <input type="hidden" name="selected_add_on" value="">
                                                    <input type="hidden" name="add_on_quantity" value="">

                                                    <div class="additionalOns_boxFooter">
                                                        <ul>
                                                            <li>
                                                                <a
                                                                    class="addOns_skip_btn all_btn outlined_dark_green_btn btn_large uppercase">
                                                                    <span class="mr_auto">SKIP</span> </a>
                                                            </li>
                                                            <li>
                                                                <a
                                                                    class="addOns_continue_btn all_btn btn_large uppercase">
                                                                    <span class="mr_auto">Continue</span> </a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="passengerDetail_sec">
                                                    <div class="passengerDetail animatedParent animateOnce">
                                                        <div class="passengerDetailHeading">
                                                            ...
                                                            <div class="bookSfari_edit_pDetailsBtn_parent">
                                                                <button type="button"
                                                                    class="all_btn icon_btn uppercase outlined_green_btn bookSfari_edit_pDetailsBtn">
                                                                    <i>
                                                                        <svg width="18" height="18" viewBox="0 0 18 18"
                                                                            fill="none"
                                                                            xmlns="http://www.w3.org/2000/svg">
                                                                ...
                                                                <div class="ride_tabs_content">
                                                                    <div class="ride_tab_show tab_rides p_detail_form"
                                                                        ...
                                                                        <div class="rides_form">
                                                                                ...
                                                                                <div class="form_cell w_50">
                                                                                    <div class="form_field">
                                                                                        <input type="text"  id="phone"  name="phone"
                                                                                            class="floating-input" value="{{ !empty(auth()->user()) ? auth()->user()->mobile_number : ''}}"
                                                                                            placeholder="Phone" />
                                                                                        <label
                                                                                ...
                                                                                <div class="form_cell w_50">
                                                                                    <div class="form_field">
                                                                                        <input type="text"
                                                                                            ...
                                                                                            placeholder="WhatsApp" id="phone1" />
                                                                                        <label
                                                                            ...
                                                                            <div class="p_additional_secMain">
                                                                                ...
                                                                                <div
                                                                                    class="p_additional_details padb-0">
                                                                                    <ul>
                                                                                        {{-- <li>
                                                                                            <div class="p_ad_info">
                                                                                                <div
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <strong class="child_amount">{{ !empty($feature_rates->children_seat_charges) ? number_format($feature_rates->children_seat_charges,2) : 0}} AED</strong>
                                                                                                </div>
                                                                                            </div>
                                                                                        </li> --}}
                                                                                        {{-- <li>
                                                                                            <div class="p_ad_info">
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <strong class="photography_amount">{{ !empty($feature_rates->photography_charges) ? number_format($feature_rates->photography_charges,2) : 0}}
                                                                                                     AED</strong>
                                                                                                </div>
                                                                                            </div>
                                                                                        </li> --}}
                                                                                ...
                                                                                <div
                                                                                    class="form_row p_nextBtnWidth pt_20">
                                                                                    <div class="form_cell padb-0">
                                                                                        <input type="hidden" name="step_two_post_url" value="{{ route('safari.step.two.post') }}">
                                                                                        <input type="hidden" name="step_two_csrf" value="{{ csrf_token() }}">
                                                                                        <a
                                                                                            class="p_nextBtn-safari all_btn btn_large w_100 justify_content_center uppercase">
                                                                                            <span
                                                    ...
                                                    <div class="passenger_payment_inner">
                                                                ...
                                                                <div class="p_paymentDetails_info">
                                                                    <ul>
                                                                        ...
                                                                        <li class="addon-li">
                                                                            <div class="p_price_breakdown">
                                                                                <span>Add On :</span>
                                                                                <strong class="ad_amount">AED 5.00</strong>
                                                                            </div>
                                                                        </li> --}}
                                                                    </ul>
                                                        ...
                                                        <div class="p_payment_plan">
                                                            ...
                                                            <div class="p_payment_plan_right">
                                                                <button
                                                                    class="all_btn cashOnArrivalBtn selectPaymentBtn"
                                                                    type="button"  type="button" data-type="cash">
                                                        ...
                                                        <div class="payment_terms_checks">
                                                            <div class="checkbox-wrapper terms-wrapper">
                                                                ...
                                                                <p class="terms"><a href="javascript:void(0);">Terms &
                                                                        Conditions</a> - <a
                                                                        href="javascript:void(0);">Booking
                                                                        Conditions</a>
                                                                    and <a href="javascript:void(0);">Privacy
                                                                        Policy</a>. *
                                                                </p>
                                                            </div>
                                                        ...
                                                        <div class="p_payment_confirm_btn p_nextBtnWidth">
                                                            <a href="javascript:void(0)"
                                                                class="all_btn btn_large w_100 justify_content_center uppercase btn-safari-confirm"
                                                ...
                                                <div class="v_fromTo_box_row">
                                                            ...
                                                            {{-- <li>
                                                                <div class="v_fromTo_box_info">
                                                                    ...
                                                                    <div class="v_fromTo_box_text">
                                                                        ...
                                                                        <p>Juanda Airport, Surabaya, Indonesia</p>
                                                                    </div>
                                                                </div>
                                                            </li> --}}
                                                        </ul>
                                                    ...
                                                    <div class="v_dateTime">
                                                        <div class="v_dateTime_title">
                                                            ...
                                                            <h5>{{ $data["ride_date"] }} - {{ $data["ride_time"] }}</h5>
                                                        </div>
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li>
                                                                    <div class="v_dateTime_text">
                                                                        ...
                                                                        <span>{{ $total_passengers }} <br> {{ $total_passengers > 1 ? 'Passengers' : 'Passenger'}}</span>
                                                                    </div>
                                                                </li>
                                                                <li>
                                                                    <div class="v_dateTime_text">
        ...
        <!-- sfari booking view detail popup html -->
    <div class="all_popup bookSafari_info_popup">
            ...
            <div class="all_popup_table_cell">
                <div class="all_popup_inner">
                    <div class="all_popup_box">
                        ...
                        <div class="bookSfariPop_content">
                            <div class="bookSfariPop_flexible">
                                <div class="bookSfariPop_left">
                                    <h3>About</h3>
                                    <p>This is the ultimate desert safari experience in Dubai. On an Evening Desert
                                        Safari, you will discover the magic and charm of the Dubai desert, experiencing
                                        a world of natural wonder, indigenous wildlife, and Bedouin culture.</p>

                                    <p><strong>Language:</strong> English, Arabic </p>

                                    <ul>
                                        <li>
                                            <i><img src="{{ asset('front/safari/images/sfariBookInfo1.svg') }}" alt="#"></i>
                                            <span>Private Transfers</span>
                                        </li>
                                        <li>
                                            <i><img src="{{ asset('front/safari/images/sfariBookInfo2.svg') }}" alt="#"></i>
                                            <span>Henna hand painting</span>
                                        </li>
                                        <li>
                                            <i><img src="{{ asset('front/safari/images/sfariBookInfo3.svg') }}" alt="#"></i>
                                            <span>Desert Dune Drive</span>
                                        </li>
                                        <li>
                                            <i><img src="{{ asset('front/safari/images/sfariBookInfo4.svg') }}" alt="#"></i>
                                            <span>BBQ dinner</span>
                                        </li>
                                        <li>
                                            <i><img src="{{ asset('front/safari/images/sfariBookInfo5.svg') }}" alt="#"></i>
                                            <span>Sunset Stop</span>
                                        </li>
                                        <li>
                                            <i><img src="{{ asset('front/safari/images/sfariBookInfo6.svg') }}" alt="#"></i>
                                            <span>Unlimited soft drinks</span>
                                        </li>
                                        <li>
                                            <i><img src="{{ asset('front/safari/images/sfariBookInfo7.svg') }}" alt="#"></i>
                                            <span>Modern Bedouin style camp</span>
                                        </li>
                                        <li>
                                            <i><img src="{{ asset('front/safari/images/sfariBookInfo8.svg') }}" alt="#"></i>
                                            <span>Entertainment (fire and dance show)</span>
                                        </li>
                                        <li>
                                            <i><img src="{{ asset('front/safari/images/sfariBookInfo9.svg') }}" alt="#"></i>
                                            <span>Camel ride</span>
                                        </li>
                                        <li>
                                            <i><img src="{{ asset('front/safari/images/sfariBookInfo10.svg') }}" alt="#"></i>
                                            <span>Shisha (optional)</span>
                                        </li>
                                        <li>
                                            <i><img src="{{ asset('front/safari/images/sfariBookInfo11.svg') }}" alt="#"></i>
                                            <span>Sand boarding</span>
                                        </li>
                                        <li>
                                            <i><img src="{{ asset('front/safari/images/sfariBookInfo12.svg') }}" alt="#"></i>
                                            <span>Premium beverages (opt)</span>
                                        </li>
                                    </ul>
                                </div>
                                <div class="bookSfariPop_right">
                                    <div class="bookSfariPop_rightBox">
                                        <h3>What's included:</h3>
                                        <ul>
                                            <li>Transfers to and from your hotel or residence to the Dubai Desert
                                                Conservation Reserve</li>
                                            <li>Thrilling 4x4 dune drive across the desert dunes</li>
                                            <li>Camel ride on an Arabian Camel</li>
                                            <li>Short sandboarding lesson</li>
                                            <li>Sunset stop to watch one of nature's greatest sights</li>
                                            <li>BBQ dinner in a traditional Bedouin setting</li>
                                            <li>Unlimited soft drinks included in each package. House and Premium
                                                upgrade options available both during booking and while on safari</li>
                                            <li>A dedicated Arabian Adventures driver/guide throughout your safari</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    // book sfari select button
    


    // book sfari change vehicle button click

    $("body").on("click", ".bookSfariChangeVehicleBtn", function () {
    ...
    // skip add ons button click

    $("body").on("click", ".addOns_skip_btn", function () {
        let parent = $(this).closest('.additionalOns_sec');
        $(parent).addClass("active");

        let addOnRow = $(parent).find('.additionalOns_row');
         let activeRowLen = $(addOnRow).filter('.active').length;
         $(addOnRow).hide();
         if(activeRowLen > 0){
            $(addOnRow).filter('.active:first').show();
         }else{
            $(addOnRow).first().show();
         }
    ...
    // add on continue button click
    $("body").on("click", ".addOns_continue_btn", function () {

        let selected_add_on = $('[name="selected_add_on"]').val();

        if (selected_add_on) {
            
            let add_on_arr = selected_add_on.split(","),
                status = true;

                add_on_arr.forEach((num, index) => {

                    var quantity = $('[name="add-on-quantity-'+num+'"]').val();

                    if (quantity === "" || quantity < 0) {
                        
                        $('[name="add-on-quantity-'+num+'"]').parent().after("<span class='error_text'>Can not Add addon with no quantity</span>");
                        $('[name="add-on-quantity-'+num+'"]').addClass("error_stroke");
        ...
        $('.passengerDetail_sec').removeClass("active");
        $('.passengerDetail_sec').show();
        $('.p_nextBtnWidth').show();
        $('.passenger_payment').hide();
        ...
        //$('.additionalOns_row').addClass("hide");

        //$('.add-'+selected_add_on).removeClass("hide");
    ...
    // edit add on button click
    $("body").on("click", ".editAddOnsBtn", function () {
        let parent = $(this).closest('.additionalOns_sec');
        $(parent).removeClass("active");

        $(parent).find('.additionalOns_row').show();
    ...
    // edit passanger details button

    $("body").on("click", ".bookSfari_edit_pDetailsBtn", function () {
    ...
    $("body").on("click", ".additionalOns_btn", function () {
        let parent = $(this).closest('.additionalOns_box');
        $(parent).addClass("active");
        var id = $(this).data("id");

        let selected_values = $('[name="selected_add_on"]').val(),
            value_string = '';

        if(selected_values){
            
            let selected_arr = selected_values.split(",");
            if (selected_arr.length > 0) {
                if (!selected_arr.includes(id)) {
                    selected_arr.push(id);
                }

                value_string = selected_arr.join(",");
        ...
        $('[name="selected_add_on"]').val(value_string);
    });

    $("body").on("click", ".sfariBookDetail_btn", function () {
        $(".bookSafari_info_popup").show();
        $("body, html").addClass("hidden");
    });
    // Increment functionality
    $('.sb_increament_btn').on('click', function () {
        ...
        if ($input.hasClass("error_stroke")) {
                $input.removeClass("error_stroke");
                $input.closest(".error_text").remove();
            }

        if (input_name === "quantity") {

            var class_arr = $input.attr("class").split(" ");
            let class_name = class_arr[class_arr.length - 1] ? class_arr[class_arr.length - 1] : "";
            
            if (class_name) {
                
                var id_arr = class_name.split("-");
                let id = id_arr.length > 0 ? id_arr[1] : 0;
                let single_price = $('.single_price-'+id).val(),
                    discount_amount = $('.discount_amount-' + id).val(),
                    apply_discount = $('.apply_discount-'+id).val();
                let ride_amount = parseFloat(single_price) * parseFloat(quantity),
                    discounted_amount = 0;
                
                if (apply_discount == 1) {
                    
                    var discount_amt = parseFloat(ride_amount) * parseFloat(discount_amount) / 100;
                    discounted_amount = ride_amount - discount_amt;

                  $('.original-price-'+id).html(parseFloat(ride_amount).toFixed(2) + " AED");
                  $('.discounted-price-'+id).html(parseFloat(discounted_amount).toFixed(2) + " AED");
                }
        ...
        if (class_name == "add-on-quantity") {
            
            let add_on_arr = input_name.split("-");
            let id = add_on_arr.length >= 3 ? add_on_arr[3] : 0;

            let single_price = $('[name="add_on_price-'+id+'"]').val(),
                discount_amount = $('[name="add_on_discount-'+id+'"]').val(),
                apply_discount = $('[name="apply_discount-'+id+'"]').val();

            let add_on_amount = parseFloat(single_price) * parseFloat(quantity),
                    discounted_amount = 0;
                
                if (apply_discount == 1) {
                    
                    var discount_amt = parseFloat(add_on_amount) * parseFloat(discount_amount) / 100;
                    discounted_amount = add_on_amount - discount_amt;

                  $('.add-on-original-price-'+id).html(parseFloat(add_on_amount).toFixed(2) + " AED");
                  $('.add-on-discounted-price-'+id).html(parseFloat(discounted_amount).toFixed(2) + " AED");
                }

        }

        var section = $(this).closest('.bookingCardList');

    });

    // Decrement functionality
    $('.sb_decrement_btn').on('click', function () {
        var $input = $(this).siblings('.number-input');
        var currentValue = parseInt($input.val()) || 0,
            quantity = currentValue == 0 ? 0 : currentValue - 1,
            input_name = $input.prop("name");
    ...
    $("body").on("click", ".p_nextBtn-safari", function (e) {
        let status = true;
        ...
        if ($.trim(full_name) === "") {
            $(form).find("[name='full_name']").parent().after("<span class='error_text'>Full Name is required</span>");
        ...
        if ($.trim(email) == "") {
            ...
            $(form).find("[name='email']").parent().after('<span class="error_text">Email is required</span>');
            if (status == true) {
            ...
            $(form).find("[name='email']").addClass("error_stroke");
            $(form).find("[name='email']").parent().after('<span class="error_text">Invalid email address</span>');
            if (status == true) {
               $(form).find("[name='email']").focus(); 
            }
            status = false;
        ...
        if ($.trim(phone) === "") {
            $(form).find("[name='phone']").parent().after("<span class='error_text'>Phone Number is required</span>");
            ...
            $(form).find("[name='phone']").parent().after("<span class='error_text'>Phone Number must be numeric</span>");
            $(form).find("[name='phone']").addClass("error_stroke");
            if (status == true) {
               $(form).find("[name='phone']").focus(); 
            }
        ...
        if ($.trim(whatsapp) === "") {
            $(form).find("[name='whatsapp']").parent().after("<span class='error_text'>WhatsApp Number is required</span>");
            $(form).find("[name='whatsapp']").addClass("error_stroke");
            status = false;
        } else if (!/^\d+$/.test(whatsapp)) {
            $(form).find("[name='whatsapp']").parent().after("<span class='error_text'>WhatsApp Number must be numeric</span>");
            $(form).find("[name='whatsapp']").addClass("error_stroke");
            status = false;
        }

        var selected_package = $('[name="selected_package_id"]').val(),
            selected_quantity = $('[name="selected_quantity"]').val();
        ...
        if (selected_add_on) {
            ...
            let add_on__arr = selected_add_on.split(",");
            add_on__arr.forEach((num, index) => {
                
                if(add_on_quantity){
                    add_on_quantity += ","+$('[name="add-on-quantity-'+num+'"]').val();
                }else{
                  add_on_quantity = $('[name="add-on-quantity-'+num+'"]').val();  
                }
            });
            // add_on_quantity = $('[name="add-on-quantity-'+selected_add_on+'"]').val();
        }
        ...
        if (status) {
            ...
            var formData = {
                ...
                phone: phone,
                whatsapp: whatsapp,
                flight_details : $('[name="flight_details"]').val(),
                meet_greet: $('[name="meet_greet"]').val(),
                notes: $('.floating-textarea').val(),
                child_seat : $('[name="child_seat"]').val(),
                photography: $('[name="photography"]').val(),
                select_tip: $('[name="select_tip"]').val(),
            ...
            $.ajax({
                type:"post",
                url: "{{ route('safari.step.two.post') }}",
                dataType:"json",
                data: formData,
                success:function(data){
                    ...
                    if (data.success === true) {
                        ...
                        var onwards = parseFloat(data.records.ride_amount).toFixed(2);

                        $(".outward").text("AED " + onwards);

                        if (data.selected_add_on_arr) {
                            
                            var html_content = "";
                            $.each(data.selected_add_on_arr,function(){

                                var quantity = this.quantity,
                                    amount = parseFloat(this.amount).toFixed(2),
                                    title = this.title;

                                html_content +='<li><div class="p_price_breakdown"><span>('+quantity+') '+title+' :</span><strong class="ad_amount">AED '+amount+'</strong></div></li>';
                            });

                            if (html_content) {
                                
                                $('.outward').parent().parent().after(html_content);
                            }
                        }
                        $(".total_amount").text(
                            "AED " + parseFloat(data.records.total_ride_amount).toFixed(2)
                        );
                        nextButtonTrigger(btn_next);
                    }
                }
            })

        } else {
            scrollToErrorTrigger(btn_next)
        }

    });

    $(document).on('click','.btn-safari-confirm',function(e){
        e.preventDefault();

        var subscribe = $('[name="subscribe"]').is(":checked") ? 1 : 0;

        $(".btn-safari-confirm").addClass("disabled-button");
        ...
        if (!$('[name="accept"]').is(":checked")) {
            ...
            $(".btn-safari-confirm").removeClass("disabled-button");
            return;
        }
        ...
        grecaptcha.execute(captcha_key, { action: "submit" }).then(function (token) {
                ...
                $.ajax({
                    type:"post",
                    url:"{{ route('safari.booking.confirm') }}",
                    dataType:"json",
                    data: {
    ...
    function nextButtonTrigger(element) {
        ...
        $('.passengerDetail_sec').addClass("active");
    ...
    function scrollToErrorTrigger(element) {
        let headerHeight = $('.header_main').outerHeight();
        let offset = $(element).closest('.p_detail_form').find(".error_stroke:first").offset().top - 30;
        var adjustedPosition = offset - headerHeight;
