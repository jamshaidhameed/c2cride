        ...
        <div class="table-col">
            ...
            <div class="table-col">
                <div class="table-booking-info">
                    ...
                    <div class="bkg-block">
                        <!-- @if($ride->way=='2')
                            {{count($ride->coupons)>0? number_format($ride->price - ($ride->price * $ride->coupons[0]['discount_percentage']) / 100):number_format($ride->price)}} AED |
                        @else
                            {{count($ride->coupons)>0? number_format($ride->price - ($ride->price * $ride->coupons[0]['discount_percentage']) / 100):number_format($ride->price)}}
                            AED |
                        @endif -->
                        {{$ride->price}} AED
                    ...
                    <div class="ride-status-col">
                        <div class="rd-status-block">
                            <div class="table-select-box">
                                <select name="ride_status" class="ride_status" data-ride_id="{{$ride->id}}" disabled>
                        ...
                        @if($ride->status == 1 && !empty($ride->driver->nick_name))
                            ...
                            <!-- Assigned amount : {{ number_format($ride->assigned_amount) }} AED -->
                             Assigned amount : {{ $ride->assigned_amount }} AED
                        @endif
                        <br>
