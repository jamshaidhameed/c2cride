<div class="rides_form">
    <input type="hidden" name="city_tour_token" value="{{ csrf_token() }}">
    <input type="hidden" name="ride_type_id" value="3">
    <input type="hidden" name="step_one_url" value="{{ route('rides.step.one') }}">
    <div class="form_row">
        <div class="form_cell">
            <div class="form_field">
                <input type="text" name="cityTour_from" id="cityTour_from"
    ...
    <div class="form_row">
        <div class="form_cell">
            <div class="form_field">
                <input type="text" name="cityTour_to" id="cityTour_to"
    ...
    <div class="form_row">
        <div class="form_cell cellCol50">
            <div class="form_field">
                ...
                <input type="text" name="cityTour_date"
        ...
        <div class="form_cell cellCol50">
            <div class="form_field time-picker-container">
                <input name="cityTour_time" type="text" readonly
    ...
    <!-- <div class="form_row">
        <div class="form_cell">
            <div class="formSelect form-floating">
                <select name="SelectDesiredCity" id="SelectDesiredCity"
                    class="SelectDesiredCity select2">
                    <option value="" disabled selected>Select Desired City
                    </option>
                ...
                <label class="floating-label" for="SelectDesiredCity">Desired
                    City</label>
                <i class="field_icon"><svg width="22" height="22"
                        ...
                        <path
                            ...
                            stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M8.25 1.83203L12.7875 20.1654" stroke="#8D8D8D"
                            stroke-width="1.375" stroke-linecap="round"
                            stroke-linejoin="round" />
                        <path d="M10.5694 11.2031L1.8335 13.7515"
                            stroke="#8D8D8D" stroke-width="1.375"
                            stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
    ...
    <div class="form_row">
        <div class="form_cell cellCol50">
            <div class="formSelect form-floating fieldTransparentDisabled">
                <select name="SelectDesiredCity" id="SelectCity"
                    class="SelectDesiredCity selectCity"
                    data-placeholder="Select City">
                    <option value="" disabled selected>Select City
                    </option>
                    <option value="Dubai" @if(isset($city) && $city == "Dubai") selected @endif>Dubai</option>
                    <option value="Sharjah" @if(isset($city) && $city == "Sharjah") selected @endif>Sharjah</option>
                    <option value="Abu Dhabi" @if(isset($city) && $city == "Abu Dhabi") selected @endif>Abu Dhabi</option>
                    <option value="Ajman" @if(isset($city) && $city == "Ajman") selected @endif>Ajman</option>
                    <option value="Ras Al Khaimah" @if(isset($city) && $city == "Ras Al Khaimah") selected @endif>Ras Al Khaimah </option>
                    <option value="Fujairah" @if(isset($city) && $city == "Fujairah") selected @endif>Fujairah</option>
                    <option value="Al Ain" @if(isset($city) && $city == "Al Ain") selected @endif>Al Ain</option>
                    <option value="Um al quwaim" @if(isset($city) && $city == "Um al quwaim") selected @endif>Um al quwaim</option>
                </select>
                <label class="floating-label" for="SelectDesiredCity">Select
                    City</label>
                <i class="field_icon">
        ...
        <div class="form_cell cellCol50">
            <div class="formSelect form-floating fieldTransparentDisabled">
                <select name="SelectFullDayField" id="SelectSelectHours"
                    class="SelectDesiredCity fullHours"
                    data-placeholder="Select Hours">
                    <option value="" disabled selected>Select Hours
                    </option>
                    <option value="10">Full day 10h</option>
                    <option value="5">half day 5 hours</option>
                </select>
                <label class="floating-label" for="SelectFullDayField">Select
                    Hours</label>
                <i class="field_icon">
                    <svg width="22" height="23" viewBox="0 0 22 23" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M13.9696 1.84766H8.02963C4.58296 1.84766 4.31713 4.94599 6.17796 6.63266L15.8213 15.396C17.6821 17.0827 17.4163 20.181 13.9696 20.181H8.02963C4.58296 20.181 4.31713 17.0827 6.17796 15.396L15.8213 6.63266C17.6821 4.94599 17.4163 1.84766 13.9696 1.84766Z"
                            stroke="#8D8D8D" stroke-width="1.5"
                            stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
    ...
    <div class="form_row">
        <div class="form_cell padb-0">
            <a
                class="all_btn  btn_large flexible icon_btn justify_content_between uppercase cityTour_search_btn">
