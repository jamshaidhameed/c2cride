                                ...
                                <div class="bp_banner_left">
                                    <div class="bp_banner_left_inner">
                                        <div class="banner_text">
                                            ...
                                            <p class="animated fadeInUpShort slow delay-500">Partner with C2C Ride and deliver quality rides for your executives. Enjoy premium chauffeured rides, flexible booking and committed support, all designed to fit your workflow.
                        ...
                        <div class="autoContent">
                            <div class="bp_a_list_inner animated fadeInUpShort slow">
                                <ul>
                                    ...
                                    <li>
                                        <div class="bp_a_list_detail">
                                            <h4>Our team will contact you for a full consultation.</h4>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="bp_a_list_detail">
                                            <h4>Review and sign the partnership agreement  </h4>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="bp_a_list_detail">
                                            <h4>Start using C2C Ride to request rides quickly. </h4>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                                            ...
                                            <ul>
                                                <li class="animated fadeInUpShort slow">
                                                    <div class="hw_box">
                                                        ...
                                                        <div class="hw_box_data">
                                                            <h4>Get priority access</h4>
                                                            <p>Faster chauffer arrival to reduce wait times.</p>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li class="animated fadeInUpShort slow delay-250">
                                                    <div class="hw_box">
                                                        ...
                                                        <div class="hw_box_data">
                                                            <h4>Fair fare policy</h4>
                                                            <p>Enjoy transparent prices with no extra charges.
                                                            </p>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li class="animated fadeInUpShort slow delay-500">
                                                    <div class="hw_box">
                                                        ...
                                                        <div class="hw_box_data">
                                                            <h4>Global access  </h4>
                                                            <p>Avail premium services in major cities across the world.</p>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li class="animated fadeInUpShort slow delay-250">
                                                    <div class="hw_box">
                                                        ...
                                                        <div class="hw_box_data">
                                                            ...
                                                            <p>Easy and immediate booking with real time availability.</p>
                                                        </div>
                                                    </div>
                                                </li>
                                            </ul>
                                        ...
                                        <div class="aboutMe_detail_inner animatedParent animateOnce">
                                            <div class="aboutMe_detail_left">
                                                <div class="aboutMe_info">
                                                    ...
                                                    <p class="animated fadeInUpShort slow delay-250">C2C Ride provides reliable, flexible, and professional chauffeur services for corporate travel needs. Whether it's an airport transfer or executive travel, we make sure your business travels are secure, professional and always on time.
</p>
                                                    <strong class="animated fadeInUpShort slow delay-500">Our goal is to provide reliable, high quality business transport that streamline business travel, improve executive mobility, and assure a seamless experience for businesses of all sizes.
</strong>
                                                </div>
                                            </div>
                                                ...
                                                <div class="accordion">
                                                    <div class="accordion_item active">
                                                        <div class="accordion_header">
                                                            <strong>(Q) How early can I book a ride? </strong>
                                                            <span class="plus_icon"></span>
                                                        </div>
                                                        <div class="accordion_body" style="display: block;">
                                                            <div class="accordion_content">
                                                                <p>Rides can be scheduled as early as 30 minutes in advance</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="accordion_item">
                                                        <div class="accordion_header">
                                                            <strong>(Q) Can we customize ride services for our corporation’s needs?</strong>
                                                            <span class="plus_icon"></span>
                                                        </div>
                                                        <div class="accordion_body">
                                                            <div class="accordion_content">
                                                                <p>Yes, ride options can be tailored by vehicle type, timing, and priority access.</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="accordion_item">
                                                        <div class="accordion_header">
                                                            <strong>(Q) What vehicle options are available?</strong>
                                                            <span class="plus_icon"></span>
                                                        </div>
                                                        <div class="accordion_body">
                                                            <div class="accordion_content">
                                                                <p>We offer Standard, Premium, and Executive vehicles to suit guest preferences.</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="accordion_item">
                                                        <div class="accordion_header">
                                                            <strong>(Q) Do drivers speak English?</strong>
                                                            <span class="plus_icon"></span>
                                                        </div>
                                                        <div class="accordion_body">
                                                            <div class="accordion_content">
                                                                <p>Yes, all drivers speak English and the local language.</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="accordion_item">
                                                        ...
                                                        <div class="accordion_body">
                                                            <div class="accordion_content">
                                                                <p>We accept all standard payment methods including card and cash.</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="accordion_item">
                                                        <div class="accordion_header">
                                                            <strong>(Q)  Is C2C Ride eco-friendly?</strong>
                                                            <span class="plus_icon"></span>
                                                        </div>
                                                        <div class="accordion_body">
                                                            <div class="accordion_content">
                                                                <p>Yes, with electric/hybrid options and carbon offset for all rides. </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="accordion_item">
                                                        <div class="accordion_header">
                                                            <strong>(Q) Can we manage multiple bookings at once?</strong>
                                                            <span class="plus_icon"></span>
                                                        </div>
                                                        <div class="accordion_body">
                                                            <div class="accordion_content">
                                                                <p>Absolutely, the platform supports bulk and multi-stop bookings.</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="ovq_right">
                                                <div class="customer_say">
                                                    <div class="headlines customer_sayBorder">
                                                        ...
                                                        <p class="animated fadeInUpShort slow delay-500">Let’s work together and expand your corporate travel with C2C Ride’s reliable travel solutions.  </p>
                                                    </div>
