...
@section('meta')
 <meta name="description" content="Relax and explore Umm Al Quwain with our private chauffeur-driven rides." />
@endsection
@section('title')
 Umm Al Quwain Tour | Explore UAE with C2C Ride
@endsection
@section("content")
<div class="content">
    <div class="gradiantParent">
        <div class="gradiantChild">
            <div class="auto_banner ct_umm_quwain_banner animatedParent animateOnce">
                <div class="autoContent">
                    <div class="banner_inner">
                        <div class="banner_box">
                            <div class="banner_text">
                                <small class="uppercase animated fadeInUpShort slow">Umm Al Quwain</small>
                                <h1 class="animated fadeInUpShort slow delay-250">
                                    Uncover Tranquility & Heritage – <span>Umm Al Quwain </span>Tour
                                </h1>
                    ...
                    <div class="our_value_inner animatedParent animateOnce">
                                ...
                                <ul>
                                    <li>
                                        <div class="ov_galary_img">
                                            <img src="{{ asset('front/images/ov_galary_img19.png') }}" alt="#">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="ov_galary_img">
                                            <img src="{{ asset('front/images/ov_galary_img20.png') }}" alt="#">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="ov_galary_img">
                                            <img src="{{ asset('front/images/ov_galary_img21.png') }}" alt="#">
                                        </div>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="ov_left">
                            <div class="headlines">
                                ...
                                <p class="animated fadeInUpShort slow delay-500">A hidden gem of tranquility, Umm Al Quwain is home to serene beaches, mangroves, and rich heritage. With C2C Ride, explore its peaceful coastline, adventure parks, and cultural sites with ease.</p>
                            </div>
                                ...
                                <ul>
                                    <li class="animated fadeInUpShort slow delay-500 w_100">
                                        ...
                                        <div class="r_c2c_left_info">
                                            <h4>Exclusive Umm Al Quwain Tour:</h4>
                                            <p>Discover the serene landscapes of Umm Al Quwain, from the breathtaking Mangrove forests to the historic Umm Al Quwain Fort. Whether you’re exploring its cultural sites or enjoying its peaceful beaches, this tour offers a perfect escape from the city's hustle.</p>
                                        </div>
                                    </li>
                                    <li class="animated fadeInUpShort slow delay-500 w_100">
                                        <div class="ct_exclusive_icon">
                                        ...
                                        <div class="r_c2c_left_info">
                                            ...
                                            <p> Our expert guides will take you on a journey through Umm Al Quwain’s past and present, sharing fascinating stories and insights in multiple languages. Experience the emirate’s rich heritage, traditional markets, and natural wonders with a guide who brings every detail to life.</p>
                                        </div>
                                    </li>
                        ...
                        <div class="visit_places_slider_main">
                            <div class="visit_places_slider">
                                <div>
                                    <div class="vp_slider_box">
                                        <div class="vp_slider_img">
                                            <img src="{{ asset('front/images/vp_dreamland.png') }}" alt="#">
                                        </div>
                                ...
                                <div>
                                    <div class="vp_slider_box">
                                        <div class="vp_slider_img">
                                            <img src="{{ asset('front/images/vp_uaq_museum.png') }}" alt="#">
                                        </div>
                                        <div class="vp_slider_text">
                                            <span>UAQ National Museum</span>
                                        </div>
                                    </div>
                                </div>
                                <div>
                                    <div class="vp_slider_box">
                                        <div class="vp_slider_img">
                                            <img src="{{ asset('front/images/vp_khor_beidah.png') }}" alt="#">
                                        </div>
                                        <div class="vp_slider_text">
                                            <span>Khor Al Beidah</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion">
                                    <div class="accordion_item active">
                                        <div class="accordion_header">
                                            <strong>(Q) Is Umm Al Quwain a good option for a visit in contrast to Dubai or Abu Dhabi?</strong>
                                            <span class="plus_icon"></span>
                                        </div>
                                        <div class="accordion_body" style="display: block;">
                                            <div class="accordion_content">
                                                <p>Umm Al Quwain’s traditional Emirati life could offer insight into cultures and lifestyles alien to those of more developed emirates. Its myriad cultural sites, complemented by rich biodiversity and wildlife, along with serene and uncrowded beaches, stand in stark juxtaposition to the urban sprawl of Dubai and Abu Dhabi.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion_item">
                                        <div class="accordion_header">
                                            <strong>(Q) What should I wear when visiting Umm Al Quwain?</strong>
                                            <span class="plus_icon"></span>
                                        </div>
                                        <div class="accordion_body">
                                            <div class="accordion_content">
                                                <p>Even though Umm Al Quwain is less developed than Dubai, comfortable and semi-modest clothing is still appropriate. Women visiting mosques should carry a scarf to cover their heads. The climate is hot in the summer months (May – September), so light and cool materials would be best. </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion_item">
                                        <div class="accordion_header">
                                            <strong>(Q) Does the tour cover hotel pickups from other emirates?</strong>
                                            <span class="plus_icon"></span>
                                        </div>
                                        <div class="accordion_body">
                                            <div class="accordion_content">
                                                <p>Yes, we offer pickups from the hotels in Dubai, Sharjah, and Ajman for a small extra charge, while pickups from the hotels in Umm Al Quwain are free. </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion_item">
                                        <div class="accordion_header">
                                            <strong>(Q) What is the most unique feature about Umm Al Quwain when compared to other emirates?</strong>
                                            <span class="plus_icon"></span>
                                        </div>
                                        <div class="accordion_body">
                                            <div class="accordion_content">
                                                <p>Umm Al Quwain exhibits the least population growth and is, therefore, home to some of the last remaining pre-oil boom Emirates. </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion_item">
