...
@section('meta')
 <meta name="description" content="Discover Abu Dhabi’s top attractions in comfort with our city tour service." />
@endsection
@section('title')
Abu Dhabi City Tour | Book Your UAE Experience - C2C Ride
@endsection
@section("content")
<div class="content">
    <div class="gradiantParent">
        <div class="gradiantChild">
            <div class="auto_banner ct_abu_dhabi_banner animatedParent animateOnce">
                <div class="autoContent">
                    <div class="banner_inner">
                        <div class="banner_box">
                            <div class="banner_text">
                                <small class="uppercase animated fadeInUpShort slow">Abu Dhabi</small>
                                <h1 class="animated fadeInUpShort slow delay-250">
                                   Explore the Exclusive Capital–<span>Abu Dhabi</span> Tours
                    ...
                    <div class="our_value_inner animatedParent animateOnce">
                                ...
                                <ul>
                                    <li>
                                        <div class="ov_galary_img">
                                            <img src="{{ asset('front/images/ov_galary_img4.png') }}" alt="#">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="ov_galary_img">
                                            <img src="{{ asset('front/images/ov_galary_img5.png') }}" alt="#">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="ov_galary_img">
                                            <img src="{{ asset('front/images/ov_galary_img6.png') }}" alt="#">
                                        </div>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="ov_left">
                            <div class="headlines">
                                ...
                                <p class="animated fadeInUpShort slow delay-500">A city of grandeur and tradition, Abu Dhabi offers breathtaking attractions like Sheikh Zayed Grand Mosque and Yas Island. Travel effortlessly with C2C Ride’s premium services.</p>
                            </div>
                                ...
                                <ul>
                                    <li class="animated fadeInUpShort slow delay-500 w_100">
                                        ...
                                        <div class="r_c2c_left_info">
                                            <h4>Exclusive Abu Dhabi Tour:</h4>
                                            <p> Explore Abu Dhabi's most iconic sites, including the stunning Sheikh Zayed Grand Mosque and the luxurious Emirates Palace, while experiencing the perfect blend of heritage and modernity.</p>
                                        </div>
                                    </li>
                                    <li class="animated fadeInUpShort slow delay-500 w_100">
                                        <div class="ct_exclusive_icon">
                                        ...
                                        <div class="r_c2c_left_info">
                                            ...
                                            <p>Our expert guides will take you through Abu Dhabi’s transformation from desert to metropolis, offering fascinating insights in multiple languages and revealing hidden gems that tell the city’s rich story.</p>
                                        </div>
                                    </li>
                        ...
                        <div class="visit_places_slider_main">
                            <div class="visit_places_slider">
                                <div>
                                    <div class="vp_slider_box">
                                        <div class="vp_slider_img">
                                            <img src="{{ asset('front/images/vp_sz_masjid.png') }}" alt="#">
                                        </div>
                                ...
                                <div>
                                    <div class="vp_slider_box">
                                        <div class="vp_slider_img">
                                            <img src="{{ asset('front/images/vp_louvre.png') }}" alt="#">
                                        </div>
                                        <div class="vp_slider_text">
                                ...
                                <div>
                                    <div class="vp_slider_box">
                                        <div class="vp_slider_img">
                                            <img src="{{ asset('front/images/vp_emirates_palace.png') }}" alt="#">
                                        </div>
                                        <div class="vp_slider_text">
                                ...
                                <div>
                                    <div class="vp_slider_box">
                                        <div class="vp_slider_img">
                                            <img src="{{ asset('front/images/vp_qasar_watan.png') }}" alt="#">
                                        </div>
                                        <div class="vp_slider_text">
                                            <span>Qasr Al Watan</span>
                                        </div>
                                    </div>
                                </div>
                                <div>
                                    <div class="vp_slider_box">
                                        <div class="vp_slider_img">
                                            <img src="{{ asset('front/images/vp_corniche_beach.png') }}" alt="#">
                                        </div>
                                        <div class="vp_slider_text">
                                            <span>Corniche Beach</span>
                                        </div>
                                    </div>
                                </div>
                                <div>
                                    <div class="vp_slider_box">
                                        <div class="vp_slider_img">
                                            <img src="{{ asset('front/images/vp_ferrari_world.png') }}" alt="#">
                                        </div>
                                        <div class="vp_slider_text">
                                ...
                                <div>
                                    <div class="vp_slider_box">
                                        <div class="vp_slider_img">
                                            <img src="{{ asset('front/images/vp_yas_island.png') }}" alt="#">
                                        </div>
                                        <div class="vp_slider_text">
                                ...
                                <div>
                                    <div class="vp_slider_box">
                                        <div class="vp_slider_img">
                                            <img src="{{ asset('front/images/vp_hindu_temple.png') }}" alt="#">
                                        </div>
                                        <div class="vp_slider_text">
                                ...
                                <div>
                                    <div class="vp_slider_box">
                                        <div class="vp_slider_img">
                                            <img src="{{ asset('front/images/vp_abrahamic_house.png') }}" alt="#">
                                        </div>
                                        <div class="vp_slider_text">
                                            <span>Abrahamic house</span>
                                        </div>
                                    </div>
                                </div>
                                <div>
                                    <div class="vp_slider_box">
                                        <div class="vp_slider_img">
                                            <img src="{{ asset('front/images/vp_sea_world.png') }}" alt="#">
                                        </div>
                                        <div class="vp_slider_text">
                                            <span>Sea world</span>
                                        </div>
                                ...
                                <div>
                                    <div class="vp_slider_box">
                                        <div class="vp_slider_img">
                                            <img src="{{ asset('front/images/vp_warner_bros.png') }}" alt="#">
                                        </div>
                                        <div class="vp_slider_text">
                                ...
                                <div class="accordion">
                                    <div class="accordion_item active">
                                        <div class="accordion_header">
                                            <strong>(Q) What is the duration of the full Abu Dhabi city tour? </strong>
                                            <span class="plus_icon"></span>
                                        </div>
                                        <div class="accordion_body" style="display: block;">
                                            <div class="accordion_content">
                                                <p>The entire Abu Dhabi city tour lasts approximately 6-8 hours, which enables us to see the major sights at a comfortable rate.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion_item">
                                        <div class="accordion_header">
                                            <strong>(Q) Do we have to pay extra to enter Sheikh Zayed Grand Mosque?</strong>
                                            <span class="plus_icon"></span>
                                        </div>
                                        <div class="accordion_body">
                                            <div class="accordion_content">
                                                <p>Sheikh Zayed Grand Mosque is included in our Abu Dhabi tour package. However, certain dress codes must be observed. For women, we provide complimentary abayas.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion_item">
                                        <div class="accordion_header">
                                            <strong>(Q) Do I get to decide which Abu Dhabi places I want to visit that interest me?</strong>
                                            <span class="plus_icon"></span>
                                        </div>
                                        <div class="accordion_body">
                                            <div class="accordion_content">
                                                <p>Yes! We have a suggested route that covers the most important attractions in Abu Dhabi, but we are more than willing to accommodate your preferences. Please just let us know what you would like at the time of booking.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion_item">
                                        <div class="accordion_header">
                                            <strong>(Q) In what ways does the Abu Dhabi tour differ from the Dubai tour?</strong>
                                            <span class="plus_icon"></span>
                                        </div>
                                        <div class="accordion_body">
                                            <div class="accordion_content">
                                                <p>Dubai is known for its modern-style buildings and extravagant shopping centers, while Abu Dhabi has beautiful mosques, temples, and heritage buildings that offer a wealth of cultural knowledge. The capital city has most of the modern architectural features of other cities, but it offers a much better scope of Emirati traditions. </p>
                                            </div>
                                        </div>
                                    </div>
                                    {{-- <div class="accordion_item">
