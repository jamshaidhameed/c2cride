...
@section('meta')
 <meta name="description" content="Travel through Ras Al Khaimah with ease using our premium chauffeur service." />
@endsection
@section('title')
Ras Al Khaimah Tour | Private Chauffeur Booking - C2C Ride
@endsection
@section("content")
<div class="content">
    <div class="gradiantParent">
        <div class="gradiantChild">
            <div class="auto_banner ct_ras_khairah_banner animatedParent animateOnce">
                <div class="autoContent">
                    <div class="banner_inner">
                        <div class="banner_box">
                            <div class="banner_text">
                                <small class="uppercase animated fadeInUpShort slow">Ras Al Khaimah</small>
                                <h1 class="animated fadeInUpShort slow delay-250">
                                    Discover Adventure & Heritage – <span>Ras Al Khaimah</span> Tour

                                </h1>
                                <p class="animated fadeInUpShort slow delay-500">Affordable and easy
                                    transportation for everyone. Enjoy hassle-free rides at great prices
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="our_value_inner animatedParent animateOnce">
                                ...
                                <ul>
                                    <li>
                                        <div class="ov_galary_img">
                                            <img src="{{ asset('front/images/ov_galary_img16.png') }}" alt="#">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="ov_galary_img">
                                            <img src="{{ asset('front/images/ov_galary_img17.png') }}" alt="#">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="ov_galary_img">
                                            <img src="{{ asset('front/images/ov_galary_img18.png') }}" alt="#">
                                        </div>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="ov_left">
                            <div class="headlines">
                                ...
                                <p class="animated fadeInUpShort slow delay-500">A haven for adventure seekers, Ras Al Khaimah boasts stunning mountains, pristine beaches, and thrilling outdoor activities. C2C Ride takes you on a seamless journey to explore it all.</p>
                            </div>
                                ...
                                <ul>
                                    <li class="animated fadeInUpShort slow delay-500 w_100">
                                        ...
                                        <div class="r_c2c_left_info">
                                            <h4>Exclusive Ras Al Khaimah Tour:</h4>
                                            <p> Embark on a journey through Ras Al Khaimah’s most stunning landmarks, from the towering peaks of Jebel Jais to the historic Dhayah Fort. Experience a perfect blend of adventure, history, and natural beauty, making every moment truly memorable.</p>
                                        </div>
                                    </li>
                                    <li class="animated fadeInUpShort slow delay-500 w_100">
                                        <div class="ct_exclusive_icon">
                                        ...
                                        <div class="r_c2c_left_info">
                                            ...
                                            <p>Our experienced guides will lead you through Ras Al Khaimah’s fascinating transformation, sharing captivating stories and hidden gems in multiple languages. Whether exploring ancient ruins or taking in the emirate’s scenic wonders, we ensure a deeper, more enriching experience.</p>
                                        </div>
                                    </li>
                                ...
                                <div>
                                    <div class="vp_slider_box">
                                        <div class="vp_slider_img">
                                            <img src="{{ asset('front/images/vp_jebel_jais.png') }}" alt="#">
                                        </div>
                                        <div class="vp_slider_text">
                                            <span>Jebel Jais</span>
                                        </div>
                                    </div>
                                </div>
                                <div>
                                    <div class="vp_slider_box">
                                        <div class="vp_slider_img">
                                            <img src="{{ asset('front/images/vp_marjan_island.png') }}" alt="#">
                                        </div>
                                        <div class="vp_slider_text">
                                            <span>Al Marjan Island</span>
                                        </div>
                                    </div>
                                </div>
                                <div>
                                    <div class="vp_slider_box">
                                        <div class="vp_slider_img">
                                            <img src="{{ asset('front/images/vp_dhayah_fort.png') }}" alt="#">
                                        </div>
                                        <div class="vp_slider_text">
                                            <span>Dhayah Fort</span>
                                        </div>
                                    </div>
                                </div>
                                <div>
                                    <div class="vp_slider_box">
                                        <div class="vp_slider_img">
                                            <img src="{{ asset('front/images/vp_wadi_shawka.png') }}" alt="#">
                                        </div>
                                        <div class="vp_slider_text">
                                            <span>Wadi Shawka</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion">
                                    <div class="accordion_item active">
                                        <div class="accordion_header">
                                            <strong>(Q) What experiences in Ras Al Khaimah can C2CRides help me explore?</strong>
                                            <span class="plus_icon"></span>
                                        </div>
                                        <div class="accordion_body" style="display: block;">
                                            <div class="accordion_content">
                                                <p>Our rides include the Jebal Jais Flight (the longest zipline in the world), desert safaris, Via Ferrata climbing, water sports, hiking, and even hot air balloon rides. We manage clients with as many adventure providers as possible to enhance the experience. </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion_item">
                                        <div class="accordion_header">
                                            <strong>(Q) Is Ras Al Khaimah suitable for families with children?</strong>
                                            <span class="plus_icon"></span>
                                        </div>
                                        <div class="accordion_body">
                                            <div class="accordion_content">
                                                <p>Of course! RAK is known for family-friendly beaches, the Suwaidi Pearl Farm, Iceland Waterpark, and milder adventures like the Jais Sky Tour (a series of mini zip lines). Child seats are available in our vehicles upon request.  </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion_item">
                                        <div class="accordion_header">
                                            <strong>(Q) In what ways is having a desert experience in RAK different from the other emirates?</strong>
                                            <span class="plus_icon"></span>
                                        </div>
                                        <div class="accordion_body">
                                            <div class="accordion_content">
                                                <p>The deserts of Ras Al Khaimah are remarkable for their colored terracotta dunes, more genuine Bedouin experiences, and fewer tourists than other cities. Our drivers take you to private desert camps where authentic life is maintained away from commercial tourist centers.  </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion_item">
                                        <div class="accordion_header">
                                            <strong>(Q) Is there a luxury experience offered in Ras Al Khaimah?</strong>
                                            <span class="plus_icon"></span>
                                        </div>
                                        <div class="accordion_body">
                                            <div class="accordion_content">
                                                <p>RAK is now a luxury destination with top-of-the-range resorts such as Waldorf Astoria, Ritz-Carlton, and Anantara. C2CRides offers transportation to these resorts and around the RAK, allowing our clients to enjoy exclusive dinners on the beach, private mountain picnics, and other activities. </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion_item">
                                        <div class="accordion_header">
                                            <strong>(Q) Do C2CRides do night tours in Ras Al Khaimah?</strong>
                                            <span class="plus_icon"></span>
                                        </div>
                                        <div class="accordion_body">
                                            <div class="accordion_content">
                                                <p>Yes, they do! Our specialty night tours include stargazing at Jebel Jais (minimal light pollution), evening desert experiences with traditional performances, and nighttime city tours to see RAK's illuminated forts and corniches.</p>
                                            </div>
                                        </div>
                                    </div>
                                    {{-- <div class="accordion_item">
