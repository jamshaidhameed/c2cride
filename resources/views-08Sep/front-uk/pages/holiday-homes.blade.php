                                ...
                                <div class="bp_banner_left">
                                    <div class="bp_banner_left_inner">
                                        <div class="banner_text">
                                            ...
                                            <p class="animated fadeInUpShort slow delay-500">Transform your holiday home into five-star stay experience with C2C Ride. Enjoy increased bookings, effortless earnings and flexible hosting on your own terms.
                                ...
                                <ul>
                                    <li>
                                        <div class="bp_a_list_detail">
                                            <h4>Submit your property details. </h4>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="bp_a_list_detail">
                                            <h4>We reach out for a personalized consultation.</h4>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="bp_a_list_detail">
                                            <h4>Complete the verification and sign agreement.</h4>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="bp_a_list_detail">
                                            <h4>Start providing smooth transportation with C2C Ride.</h4>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <div class="bp_details_inner">
                                    <div class="bp_details_header">
                                        <div class="headlines animatedParent animateOnce">
                                            ...
                                            <p class="animated fadeInUpShort slow delay-500">C2C Ride provides safe, reliable and luxurious chauffeur service through a user-friendly platform and experienced drivers. We are committed to delivering a comfortable and on-time experience for every customer with consistency and professionalism.
</p>
                                            ...
                                            <ul>
                                                <li class="animated fadeInUpShort slow">
                                                    <div class="hw_box">
                                                        ...
                                                        <div class="hw_box_data">
                                                            ...
                                                            <p>Track bookings and income live.</p>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li class="animated fadeInUpShort slow delay-250">
                                                    <div class="hw_box">
                                                        ...
                                                        <div class="hw_box_data">
                                                            <h4>Flexible Hosting Options </h4>
                                                            <p>Create your own schedule and pricing. 
                                                            </p>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li class="animated fadeInUpShort slow delay-500">
                                                    <div class="hw_box">
                                                        ...
                                                        <div class="hw_box_data">
                                                            <h4>Boost Bookings  </h4>
                                                            <p>Draw in more visitors and raise occupancy rates.</p>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li class="animated fadeInUpShort slow delay-250">
                                                    <div class="hw_box">
                                                        ...
                                                        <div class="hw_box_data">
                                                            <h4>Constant Availability  </h4>
                                                            <p>Get help from experts whenever needed.</p>
                                                        </div>
                                                    </div>
                                                </li>
                                            </ul>
                                        ...
                                        <div class="aboutMe_detail_inner animatedParent animateOnce">
                                            <div class="aboutMe_detail_left">
                                                <div class="aboutMe_info">
                                                    ...
                                                    <p class="animated fadeInUpShort slow delay-250">Expand your holiday home business by providing trusted C2C Ride services. Our seamless transport solution enhance guest convenience, ensuring smooth arrival and departures and boost bookings through professional, on demand chauffeur services.

</p>
                                                    <strong class="animated fadeInUpShort slow delay-500">Our goal is to simplify travelling by providing safe, timely and professional rides that increase guest satisfaction and support our partners through reliable travel options.
</strong>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="accordion_item active">
                                                        ...
                                                        <div class="accordion_body" style="display: block;">
                                                            <div class="accordion_content">
                                                                <p>A valid property listing and proof of ownership or management rights.</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="accordion_item">
                                                        <div class="accordion_header">
                                                            <strong>(Q) Do we need tech skills to use the system?</strong>
                                                            <span class="plus_icon"></span>
                                                        </div>
                                                        <div class="accordion_body">
                                                            <div class="accordion_content">
                                                                <p>Not at all, our platform is simple, and we guide you every step of the way.</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="accordion_item">
                                                        <div class="accordion_header">
                                                            <strong>(Q) Can guest’s book rides through us?</strong>
                                                            <span class="plus_icon"></span>
                                                        </div>
                                                        <div class="accordion_body">
                                                            <div class="accordion_content">
                                                                <p>Yes, you can offer ride bookings as an added service for your guests.</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="accordion_item">
                                                        <div class="accordion_header">
                                                            <strong>(Q) Can I offer ride service for large groups or families?</strong>
                                                            <span class="plus_icon"></span>
                                                        </div>
                                                        <div class="accordion_body">
                                                            <div class="accordion_content">
                                                                <p>Yes, we provide multi-seater vehicles for families and groups.</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="accordion_item">
                                                        ...
                                                        <div class="accordion_body">
                                                            <div class="accordion_content">
                                                                <p>It’s based on each completed ride booked through your holiday home referral.</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="accordion_item">
                                                        <div class="accordion_header">
                                                            <strong>(Q)  Is there support for partners?</strong>
                                                            <span class="plus_icon"></span>
                                                        </div>
                                                        <div class="accordion_body">
                                                            <div class="accordion_content">
                                                                <p>Yes, we provide onboarding assistance, marketing support, and ongoing help. </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="accordion_item">
                                                        <div class="accordion_header">
                                                            <strong>(Q) How do we track guest rides and commissions?</strong>
                                                            <span class="plus_icon"></span>
                                                        </div>
                                                        <div class="accordion_body">
                                                            <div class="accordion_content">
                                                                <p>Through a real-time partner dashboard with full booking insights. </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="ovq_right">
                                                <div class="customer_say">
                                                    <div class="headlines customer_sayBorder">
                                                        <h2 class="animated fadeInUpShort slow delay-250">Grow your business with C2C Ride
                                                        </h2>
                                                        <p class="animated fadeInUpShort slow delay-500">Increase guest satisfaction and boost booking by collaborating your Holiday Home with C2C Ride.  </p>
                                                    </div>
