...
@section('meta')
    <meta name="description" content="Professional and punctual business rides in Dubai & Abu Dhabi. Schedule your next meeting ride with C2C today." />
@endsection
@section('title')
   Business Transport Services in Dubai | C2C Rides
@endsection
@section('content')
<div class="content">
    <div class="gradiantParent">
        <div class="gradiantChild">
            <div class="auto_banner rides_banner business_rides animatedParent animateOnce">
                <div class="autoContent">
                    <div class="banner_inner">
                        <div class="banner_box">
                            <div class="banner_text">
                                <small class="uppercase animated fadeInUpShort slow">Rides for Business</small>
                                <h1 class="animated fadeInUpShort slow delay-250">
                                    PROFESSIONAL RIDES CUSTOMIZED FOR YOUR <span>BUSINESS</span>
                                    NEEDS
                                </h1>
                                <p class="animated fadeInUpShort slow delay-500">Simplify corporate travel with C2C - Reliable, Efficient, Premium.</p>
                            </div>
                        </div>
                                ...
                                <ul>
                                    <li class="animated fadeInUpShort slow">
                                        <div class="hw_box">
                                            ...
                                            <div class="hw_box_data">
                                                ...
                                                <p>Enter your pickup & drop-off locations or book by the hour for flexible, uninterrupted business travel.</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="animated fadeInUpShort slow delay-250">
                                        <div class="hw_box">
                                            ...
                                            <div class="hw_box_data">
                                                ...
                                                <p>From executive sedans to luxury SUVs, our fleet offers the perfect ride for client meetings, team outings etc.</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="animated fadeInUpShort slow delay-500">
                                        <div class="hw_box">
                                            ...
                                            <div class="hw_box_data">
                                                <h4>Focus on Business, Not the Roads </h4>
                                                <p>Let us handle the traffic while you prepare for your meeting or relax after a long day.</p>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                    ...
                    <div class="banner_inner">
                        <div class="banner_box">
                            <div class="discountBox discountBoxWhite animated slow growIn delay-1000">
                                ...
                                <span>Your First Business Ride</span>
                            </div>
                            <div class="banner_text">
                                <small class="uppercase animated fadeInUpShort slow">TRAVEL SMARTER</small>
                                <h1 class="animated fadeInUpShort slow delay-250">
                                    <span> Book Now with C2C </span>
                                </h1>
                                <p class="uppercase animated fadeInUpShort slow delay-500">Business travel with convenience & professionalism. </p>
                                </p>
                            </div>
                        </div>
                ...
                <div class="autoContent">
                    <div class="our_value_inner animatedParent animateOnce">
                        <div class="ov_left">
                            <div class="headlines">
                                <span class="headlines_sub headlines_leftStar animated fadeInUpShort slow">Our
                                    Values</span>
                                <h2 class="animated fadeInUpShort slow delay-250">Your Business Success Is Our Priority. </h2>
                                ...
                                <ul class="d_block">
                                    <li class="animated fadeInUpShort slow delay-500 w_100">
                                        <div class="r_c2c_left_info">
                                            <h4>Be dependable</h4>
                                            <p>Punctuality is everything in business. We'll ensure you're always on time, whether it's for a meeting or a flight.</p>
                                        </div>
                                    </li>
                                    <li class="animated fadeInUpShort slow delay-500 w_100">
                                        <div class="r_c2c_left_info">
                                            <h4>Keep improving</h4>
                                            <p>We continually refine our services to match the dynamic needs of modern businesses.</p>
                                        </div>
                                    </li>
                                    <li class="animated fadeInUpShort slow delay-500 w_100">
                                        <div class="r_c2c_left_info">
                                            <h4>Care Like Family </h4>
                                            <p>From chauffeuring executives to team members, we deliver every ride with respect, care, and attention to detail. </p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="ov_right animated fadeInRight">
                            <figure>
                                <img src="{{ asset('front/images/business_ourValues_img.png') }}" alt="#">
                            </figure>
                        </div>
                    </div>
                                ...
                                <div class="accordion">
                                    <div class="accordion_item active">
                                        <div class="accordion_header">
                                            <strong>(Q) Can I Book a Ride for a Corporate Event?</strong>
                                            <span class="plus_icon"></span>
                                        </div>
                                        <div class="accordion_body" style="display: block;">
                                            <div class="accordion_content">
                                                <p>Absolutely! We handle corporate events, team outings, and business conferences with professionalism and class.   </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion_item">
                                        <div class="accordion_header">
                                            <strong>(Q) Do You Offer Hourly Bookings for Business Needs? </strong>
                                            <span class="plus_icon"></span>
                                        </div>
                                        <div class="accordion_body">
                                            <div class="accordion_content">
                                                <p>Yes! Book for as many hours as you need to ensure uninterrupted transportation for your day. </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion_item">
                                        <div class="accordion_header">
                                            <strong>(Q) Can I Schedule Multiple Stops? </strong>
                                            <span class="plus_icon"></span>
                                        </div>
                                        <div class="accordion_body">
                                            <div class="accordion_content">
                                                <p>Of course! Our services are flexible to accommodate multiple stops during your business trips.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion_item">
                                        <div class="accordion_header">
                                            <strong>(Q) Are Your Vehicles Equipped for Business Travel?</strong>
                                            <span class="plus_icon"></span>
                                        </div>
                                        <div class="accordion_body">
                                            <div class="accordion_content">
                                                <p>Yes! Our fleet includes spacious, Wi-Fi-enabled vehicles for those who need to work on the go.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion_item">
                                        <div class="accordion_header">
                                            <strong>(Q) How Can My Company Set Up an Account with C2C?</strong>
                                            <span class="plus_icon"></span>
                                        </div>
                                        <div class="accordion_body">
                                            <div class="accordion_content">
                                                <p>Contact us to discuss tailored solutions, including invoicing and priority bookings for your business. </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="comments_slider">
                                            ...
                                            <div class="comments_box">
                                                <div class="comments_box_inner">
                                                    <div class="comments_box_data">
                                                        <p>C2C makes business travel effortless. Their punctuality and premium service keep me stress-free on busy days.</p>
                                                    </div>
                                        ...
                                        <div>
                                            <div class="comments_box">
                                                <div class="comments_box_inner">
                                                    <div class="comments_box_data">
                                                        <p>From client pickups to team meetings, C2C's rides have become an essential part of our corporate routine.</p>
                                                    </div>
                                                    <div class="comments_box_user">
                                                        <a href="javascript:void(0);">
                                                            <i>
                                        ...
                                        <div>
                                            <div class="comments_box">
                                                <div class="comments_box_inner">
                                                    <div class="comments_box_data">
                                                        <p>Reliable, professional, and luxurious—C2C is everything you need for seamless business travel.</p>
                                                    </div>
                                                    <div class="comments_box_user">
                                                        <a href="javascript:void(0);">
                                                            <i>
                                        ...
                                        <div>
                                            <div class="comments_box">
                                                <div class="comments_box_inner">
                                                    <div class="comments_box_data">
                                                        <p>Their flexibility with last-minute changes is incredible. I can always count on them to adapt to my schedule.</p>
                                                    </div>
                                                    <div class="comments_box_user">
                                                        <a href="javascript:void(0);">
                                                            <i>
                                        ...
                                        <div>
                                            <div class="comments_box">
                                                <div class="comments_box_inner">
                                                    <div class="comments_box_data">
                                                        <p>The vehicles are top-notch, and the drivers are always courteous. C2C adds a touch of professionalism to our business trips.</p>
                                                    </div>
                                                    <div class="comments_box_user">
                                                        <a href="javascript:void(0);">
                                                            <i>
